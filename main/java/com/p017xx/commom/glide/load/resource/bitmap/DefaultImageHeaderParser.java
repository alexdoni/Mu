...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    private static final class ByteBufferReader implements Reader {
        ...
        @Override // com.xx.commom.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
    ...
    private static final class StreamReader implements Reader {
        ...
        /* renamed from: is */
        private final InputStream f1925is;

        StreamReader(InputStream inputStream) {
            this.f1925is = inputStream;
        }

        @Override // com.xx.commom.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
        public int getUInt16() throws IOException {
            return ((this.f1925is.read() << 8) & 65280) | (this.f1925is.read() & 255);
        }

        @Override // com.xx.commom.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
        public short getUInt8() throws IOException {
            return (short) (this.f1925is.read() & 255);
        }
        ...
        public long skip(long j) throws IOException {
            ...
            long j2 = j;
            while (j2 > 0) {
                long skip = this.f1925is.skip(j2);
                if (skip <= 0) {
                    if (this.f1925is.read() == -1) {
                        break;
                    }
                    skip = 1;
                }
        ...
        public int read(byte[] bArr, int i) throws IOException {
            int i2 = i;
            while (i2 > 0) {
                int read = this.f1925is.read(bArr, i - i2, i2);
                if (read == -1) {
                    break;
                }
                i2 -= read;
