...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    public static final Option<Long> TARGET_FRAME = Option.disk("com.xx.commom.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", -1L, new Option.CacheKeyUpdater<Long>() { // from class: com.xx.commom.glide.load.resource.bitmap.VideoDecoder.1
        private final ByteBuffer buffer = ByteBuffer.allocate(8);

        @Override // com.xx.commom.glide.load.Option.CacheKeyUpdater
    ...
    public static final Option<Integer> FRAME_OPTION = Option.disk("com.xx.commom.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption", 2, new Option.CacheKeyUpdater<Integer>() { // from class: com.xx.commom.glide.load.resource.bitmap.VideoDecoder.2
    ...
    public static final class AssetFileDescriptorInitializer implements MediaMetadataRetrieverInitializer<AssetFileDescriptor> {
        ...
        @Override // com.xx.commom.glide.load.resource.bitmap.VideoDecoder.MediaMetadataRetrieverInitializer
