...
public final class RoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f1928ID = "com.xx.commom.glide.load.resource.bitmap.RoundedCorners";
    private static final byte[] ID_BYTES = f1928ID.getBytes(CHARSET);
    ...
    @Override // com.p017xx.commom.glide.load.Key
    public int hashCode() {
        return Util.hashCode(-997606228, Util.hashCode(this.roundingRadius));
    }
