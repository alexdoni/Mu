...
public class ByteArrayLoader<Data> implements ModelLoader<byte[], Data> {
    ...
    public static class ByteBufferFactory implements ModelLoaderFactory<byte[], ByteBuffer> {
        ...
        public ModelLoader<byte[], ByteBuffer> build(MultiModelLoaderFactory multiModelLoaderFactory) {
            return new ByteArrayLoader(new Converter<ByteBuffer>() { // from class: com.xx.commom.glide.load.model.ByteArrayLoader.ByteBufferFactory.1
                @Override // com.xx.commom.glide.load.model.ByteArrayLoader.Converter
    ...
    public static class StreamFactory implements ModelLoaderFactory<byte[], InputStream> {
        ...
        public ModelLoader<byte[], InputStream> build(MultiModelLoaderFactory multiModelLoaderFactory) {
            return new ByteArrayLoader(new Converter<InputStream>() { // from class: com.xx.commom.glide.load.model.ByteArrayLoader.StreamFactory.1
