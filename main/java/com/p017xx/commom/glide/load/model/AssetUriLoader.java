...
import com.p017xx.commom.glide.load.data.FileDescriptorAssetPathFetcher;
import com.p017xx.commom.glide.load.data.StreamAssetPathFetcher;
...
public class AssetUriLoader<Data> implements ModelLoader<Uri, Data> {
    ...
    public static class StreamFactory implements ModelLoaderFactory<Uri, InputStream>, AssetFetcherFactory<InputStream> {
        ...
        @Override // com.xx.commom.glide.load.model.AssetUriLoader.AssetFetcherFactory
