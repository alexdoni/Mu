...
import com.p017xx.commom.glide.load.data.AssetFileDescriptorLocalUriFetcher;
import com.p017xx.commom.glide.load.data.DataFetcher;
import com.p017xx.commom.glide.load.data.FileDescriptorLocalUriFetcher;
import com.p017xx.commom.glide.load.data.StreamLocalUriFetcher;
...
public class UriLoader<Data> implements ModelLoader<Uri, Data> {
    private static final Set<String> SCHEMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(ShareInternalUtility.STAGING_PARAM, "android.resource", FirebaseAnalytics.Param.CONTENT)));
    ...
    public static class StreamFactory implements ModelLoaderFactory<Uri, InputStream>, LocalUriFetcherFactory<InputStream> {
        ...
        @Override // com.xx.commom.glide.load.model.UriLoader.LocalUriFetcherFactory
