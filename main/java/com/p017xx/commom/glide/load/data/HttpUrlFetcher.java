...
import com.p017xx.commom.glide.load.HttpException;
import com.p017xx.commom.glide.load.data.DataFetcher;
import com.p017xx.commom.glide.load.model.GlideUrl;
import com.p017xx.commom.glide.util.ContentLengthInputStream;
...
public class HttpUrlFetcher implements DataFetcher<InputStream> {
    ...
    private static class DefaultHttpUrlConnectionFactory implements HttpUrlConnectionFactory {
        ...
        @Override // com.xx.commom.glide.load.data.HttpUrlFetcher.HttpUrlConnectionFactory
