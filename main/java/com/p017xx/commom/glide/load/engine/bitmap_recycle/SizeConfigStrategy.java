...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    @Override // com.p017xx.commom.glide.load.engine.bitmap_recycle.LruPoolStrategy
    ...
    public static class KeyPool extends BaseKeyPool<Key> {
        ...
        @Override // com.p017xx.commom.glide.load.engine.bitmap_recycle.BaseKeyPool
        public Key create() {
            return new Key(this);
        }
    }
    ...
    public static final class Key implements Poolable {
        ...
        @Override // com.p017xx.commom.glide.load.engine.bitmap_recycle.Poolable
        public void offer() {
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        ...
        int i = C28441.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.xx.commom.glide.load.engine.bitmap_recycle.SizeConfigStrategy$1 */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C28441 {
