package com.p017xx.commom.glide.load.engine.executor;
...
public final class GlideExecutor implements ExecutorService {
    ...
    public interface UncaughtThrowableStrategy {
        ...
        public static final UncaughtThrowableStrategy IGNORE = new UncaughtThrowableStrategy() { // from class: com.xx.commom.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy.1
            @Override // com.xx.commom.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy
        ...
        static {
            UncaughtThrowableStrategy uncaughtThrowableStrategy = new UncaughtThrowableStrategy() { // from class: com.xx.commom.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy.2
                @Override // com.xx.commom.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy
                public void handle(Throwable th) {
            ...
            THROW = new UncaughtThrowableStrategy() { // from class: com.xx.commom.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy.3
                @Override // com.xx.commom.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy
                public void handle(Throwable th) {
                    if (th != null) {
    ...
    public static final class DefaultThreadFactory implements ThreadFactory {
        ...
        public synchronized Thread newThread(Runnable runnable) {
            Thread thread;
            thread = new Thread(runnable, "glide-" + this.name + "-thread-" + this.threadNum) { // from class: com.xx.commom.glide.load.engine.executor.GlideExecutor.DefaultThreadFactory.1
