...
import com.p017xx.commom.glide.load.engine.EngineResource;
import com.p017xx.commom.glide.load.engine.cache.DiskCache;
import com.p017xx.commom.glide.load.engine.cache.DiskCacheAdapter;
...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    @Override // com.p017xx.commom.glide.load.engine.EngineJobListener
    ...
    @Override // com.xx.commom.glide.load.engine.cache.MemoryCache.ResourceRemovedListener
    public void onResourceRemoved(Resource<?> resource) {
        this.resourceRecycler.recycle(resource);
    }

    @Override // com.xx.commom.glide.load.engine.EngineResource.ResourceListener
    ...
    public class LoadStatus {
        ...
        /* renamed from: cb */
        private final ResourceCallback f1916cb;
        private final EngineJob<?> engineJob;

        LoadStatus(ResourceCallback resourceCallback, EngineJob<?> engineJob) {
            this.f1916cb = resourceCallback;
            this.engineJob = engineJob;
        }

        public void cancel() {
            synchronized (Engine.this) {
                this.engineJob.removeCallback(this.f1916cb);
            }
        }
    }
    ...
    public static class LazyDiskCacheProvider implements DecodeJob.DiskCacheProvider {
        ...
        @Override // com.xx.commom.glide.load.engine.DecodeJob.DiskCacheProvider
    ...
    public static class DecodeJobFactory {
        ...
        final Pools.Pool<DecodeJob<?>> pool = FactoryPools.threadSafe(150, new FactoryPools.Factory<DecodeJob<?>>() { // from class: com.xx.commom.glide.load.engine.Engine.DecodeJobFactory.1
    ...
    public static class EngineJobFactory {
        ...
        final Pools.Pool<EngineJob<?>> pool = FactoryPools.threadSafe(150, new FactoryPools.Factory<EngineJob<?>>() { // from class: com.xx.commom.glide.load.engine.Engine.EngineJobFactory.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.xx.commom.glide.util.pool.FactoryPools.Factory
