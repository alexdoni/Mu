...
public final class ActiveResources {
    ...
    /* renamed from: cb */
    private volatile DequeuedResourceCallback f1914cb;
    ...
    public ActiveResources(boolean z) {
        this(z, Executors.newSingleThreadExecutor(new ThreadFactory() { // from class: com.xx.commom.glide.load.engine.ActiveResources.1
            @Override // java.util.concurrent.ThreadFactory
            public Thread newThread(final Runnable runnable) {
                return new Thread(new Runnable() { // from class: com.xx.commom.glide.load.engine.ActiveResources.1.1
    ...
    ActiveResources(boolean z, Executor executor) {
        ...
        executor.execute(new Runnable() { // from class: com.xx.commom.glide.load.engine.ActiveResources.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    void cleanReferenceQueue() {
        while (!this.isShutdown) {
            try {
                ...
                DequeuedResourceCallback dequeuedResourceCallback = this.f1914cb;
    ...
    void setDequeuedResourceCallback(DequeuedResourceCallback dequeuedResourceCallback) {
        this.f1914cb = dequeuedResourceCallback;
    }
    ...
    public void shutdown() {
        ...
        if (executor instanceof ExecutorService) {
            com.p017xx.commom.glide.util.Executors.shutdownAndAwaitTermination((ExecutorService) executor);
        }
    }
