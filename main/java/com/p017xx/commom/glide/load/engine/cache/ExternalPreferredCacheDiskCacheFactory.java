...
import com.p017xx.commom.glide.load.engine.cache.DiskLruCacheFactory;
import java.io.File;
...
public final class ExternalPreferredCacheDiskCacheFactory extends DiskLruCacheFactory {
    ...
    public ExternalPreferredCacheDiskCacheFactory(final Context context, final String str, long j) {
        super(new DiskLruCacheFactory.CacheDirectoryGetter() { // from class: com.xx.commom.glide.load.engine.cache.ExternalPreferredCacheDiskCacheFactory.1
