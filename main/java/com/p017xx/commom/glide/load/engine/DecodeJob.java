...
import com.p017xx.commom.glide.util.pool.GlideTrace;
...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    private void runWrapped() {
        int i = C28351.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C28351.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage stage) {
        int i = C28351.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage.ordinal()];
        if (i == 1) {
    ...
    <Z> Resource<Z> onResourceDecoded(DataSource dataSource, Resource<Z> resource) {
        ...
        int i = C28351.$SwitchMap$com$bumptech$glide$load$EncodeStrategy[encodeStrategy.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.xx.commom.glide.load.engine.DecodeJob$1 */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C28351 {
    ...
    public final class DecodeCallback<Z> implements DecodePath.DecodeCallback<Z> {
        ...
        @Override // com.xx.commom.glide.load.engine.DecodePath.DecodeCallback
