...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f1912ix = readShort();
        this.header.currentFrame.f1913iy = readShort();
        this.header.currentFrame.f1911iw = readShort();
        this.header.currentFrame.f1910ih = readShort();
        int read = read();
