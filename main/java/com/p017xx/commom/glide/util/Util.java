...
import com.p017xx.commom.glide.load.model.Model;
...
public final class Util {
    ...
    private static int getBytesPerPixel(Bitmap.Config config) {
        ...
        int i = C28751.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
    ...
    /* renamed from: com.xx.commom.glide.util.Util$1 */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C28751 {
