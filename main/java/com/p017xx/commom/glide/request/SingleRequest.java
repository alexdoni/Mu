...
import com.p017xx.commom.glide.load.resource.drawable.DrawableDecoderCompat;
...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback, FactoryPools.Poolable {
    ...
    private int width;
    private static final Pools.Pool<SingleRequest<?>> POOL = FactoryPools.threadSafe(CipherSuite.TLS_RSA_WITH_SEED_CBC_SHA, new FactoryPools.Factory<SingleRequest<?>>() { // from class: com.xx.commom.glide.request.SingleRequest.1
    ...
    @Override // com.p017xx.commom.glide.request.Request
    ...
    @Override // com.p017xx.commom.glide.request.ResourceCallback
