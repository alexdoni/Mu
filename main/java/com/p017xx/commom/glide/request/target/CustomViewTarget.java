...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
    ...
    public final CustomViewTarget<T, Z> clearOnDetach() {
        ...
        this.attachStateListener = new View.OnAttachStateChangeListener() { // from class: com.xx.commom.glide.request.target.CustomViewTarget.1
