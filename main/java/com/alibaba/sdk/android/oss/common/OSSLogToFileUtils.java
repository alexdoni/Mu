...
public class OSSLogToFileUtils {
    ...
    private Uri queryLogUri() {
        ...
        Cursor query = contentResolver.query(contentUri, new String[]{FileDownloadModel.f718ID}, "relative_path like ? AND _display_name=?", new String[]{"Documents/OSSLog%", "logs.csv"}, null);
