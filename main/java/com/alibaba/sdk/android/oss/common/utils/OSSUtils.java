...
public class OSSUtils {
    ...
    public static void populateCopyObjectHeaders(CopyObjectRequest copyObjectRequest, Map<String, String> map) {
        map.put(OSSHeaders.COPY_OBJECT_SOURCE, RemoteSettings.FORWARD_SLASH_STRING + copyObjectRequest.getSourceBucketName() + RemoteSettings.FORWARD_SLASH_STRING + HttpUtil.urlEncode(copyObjectRequest.getSourceKey(), "utf-8"));
    ...
    public static String buildCanonicalizedResource(String str, String str2, Map<String, String> map) {
        ...
        if (str != null || str2 != null) {
            if (str2 == null) {
                str3 = RemoteSettings.FORWARD_SLASH_STRING + str + RemoteSettings.FORWARD_SLASH_STRING;
            } else {
                str3 = RemoteSettings.FORWARD_SLASH_STRING + str + RemoteSettings.FORWARD_SLASH_STRING + str2;
            }
        }
    ...
    public static String sign(String str, String str2, String str3) {
        try {
            return "OSS " + str + CertificateUtil.DELIMITER + new HmacSHA1Signature().computeSignature(str2, str3).trim();
        } catch (Exception e) {
