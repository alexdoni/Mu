...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f306ix = readShort();
        this.header.currentFrame.f307iy = readShort();
        this.header.currentFrame.f305iw = readShort();
        this.header.currentFrame.f304ih = readShort();
        int read = read();
