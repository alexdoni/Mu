...
public class zzj extends zzg {
    ...
    public zzj(Activity activity, View.OnClickListener onClickListener) {
        ...
        this.zzq = new MyEditText.TextWatcherListener() { // from class: com.ld.sdk.ui.zzc.zzj.12
        ...
        this.zzr = new TextView.OnEditorActionListener() { // from class: com.ld.sdk.ui.zzc.zzj.2
    ...
    private void zzb(final Activity activity, final View.OnClickListener onClickListener) {
        ...
        this.zzh = zza;
        zza.setTag(5);
        this.zzh.setOnClickListener(new View.OnClickListener() { // from class: com.ld.sdk.ui.zzc.zzj.1
        ...
        this.zzl.setOnClickListener(new View.OnClickListener() { // from class: com.ld.sdk.ui.zzc.zzj.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                zzj.this.zzd.seePwdClick(zzj.this.zzl, false);
            }
        });
        this.zzm.setOnClickListener(new View.OnClickListener() { // from class: com.ld.sdk.ui.zzc.zzj.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                zzj.this.zze.seePwdClick(zzj.this.zzm, false);
            }
        });
        this.zzg.setOnClickListener(new View.OnClickListener() { // from class: com.ld.sdk.ui.zzc.zzj.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
        ...
        zzt.zza(activity, "forget_password_layout", this.zzb).setOnClickListener(new View.OnClickListener() { // from class: com.ld.sdk.ui.zzc.zzj.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                zzj.this.zza(true);
            }
    ...
    private void zzc() {
        ...
        if (zzb != null && !zzb.isEmpty()) {
            ...
            this.zzp.setAdapter((ListAdapter) new com.p008ld.sdk.p009ui.zza.zzj(this.zza, zzb, true));
            this.zzp.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.ld.sdk.ui.zzc.zzj.9
                @Override // android.widget.AdapterView.OnItemClickListener
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                    zzj.this.zzc.setText(((PublicUserInfo) zzb.get(i)).username);
                }
            });
            this.zzo.setOnClickListener(new View.OnClickListener() { // from class: com.ld.sdk.ui.zzc.zzj.10
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    zzj.this.zza(false);
                }
            });
            this.zzn.setOnClickListener(new View.OnClickListener() { // from class: com.ld.sdk.ui.zzc.zzj.11
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    zzj.this.zza(false);
                }
    ...
    public void zza(Activity activity) {
        ...
        if (!zzi.zzc(obj)) {
            ...
            zza.zzf().zza(SendType.UPDATE_PASSWORD, obj, new LDQueryCallback<String>() { // from class: com.ld.sdk.ui.zzc.zzj.3
    ...
    public void zzb() {
        ...
        zza.zzf().zza(obj2, obj3, obj, new LDQueryCallback<String>() { // from class: com.ld.sdk.ui.zzc.zzj.4
            @Override // com.p008ld.sdk.internal.LDCallback2
            /* renamed from: zza, reason: merged with bridge method [inline-methods] */
            public void done(String str, LDException lDException) {
                zza.dismiss();
