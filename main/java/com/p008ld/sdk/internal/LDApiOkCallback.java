...
public abstract class LDApiOkCallback<T> implements Callback<LDResult<T>> {
    public abstract void done(boolean z, LDException lDException);

    /* JADX INFO: Access modifiers changed from: private */
    public final void wrapDone(boolean z, LDException lDException) {
        try {
            done(z, lDException);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void onResponse(Call<LDResult<T>> call, Response<LDResult<T>> response) {
        ...
        if (response.isSuccessful()) {
            ...
            if (body != null) {
                if (body.isSuccess()) {
                    wrapDone(true, (LDException) null);
                    return;
                }
                ...
                wrapDone(call, new LDException(Integer.valueOf(intValue), message));
                return;
            }
            wrapDone(call, new LDException("body is null"));
            return;
        }
        wrapDone(call, new LDException(new HttpException(response)));
    }
        ...
        if (errorCode == zzc.ERROR_CAPTCHA.zza()) {
            ...
            if (topActivity != null) {
                if (captchaBean.getCaptchaType() == 1) {
                    new zzb(topActivity, captchaBean, new LDCallback1<String>() { // from class: com.ld.sdk.internal.LDApiOkCallback$handleSdkException$1$1
                    ...
                    new zza(topActivity, captchaBean, new LDCallback1<String>() { // from class: com.ld.sdk.internal.LDApiOkCallback$handleSdkException$1$2
                        @Override // com.p008ld.sdk.internal.LDCallback1
                        public void done(String answer) {
                            Intrinsics.checkNotNullParameter(answer, "answer");
                            if (answer.length() == 0) {
