...
final class C1630xce3d994b extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    private final String file;
    private final int importance;
    private final long offset;

    /* renamed from: pc */
    private final long f638pc;
    private final String symbol;

    private C1630xce3d994b(long j, String str, String str2, long j2, int i) {
        this.f638pc = j;
        this.symbol = str;
        this.file = str2;
        this.offset = j2;
    ...
    public String toString() {
        return "Frame{pc=" + this.f638pc + ", symbol=" + this.symbol + ", file=" + this.file + ", offset=" + this.offset + ", importance=" + this.importance + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f638pc == frame.getPc() && this.symbol.equals(frame.getSymbol()) && ((str = this.file) != null ? str.equals(frame.getFile()) : frame.getFile() == null) && this.offset == frame.getOffset() && this.importance == frame.getImportance();
    }
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame build() {
            String str = this.f639pc == null ? " pc" : "";
            if (this.symbol == null) {
                str = str + " symbol";
            }
            if (this.offset == null) {
            ...
            return new C1630xce3d994b(this.f639pc.longValue(), this.symbol, this.file, this.offset.longValue(), this.importance.intValue());
        }
    }
}
