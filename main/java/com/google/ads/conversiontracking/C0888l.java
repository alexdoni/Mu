...
import com.google.ads.conversiontracking.C0884h;
...
public final class C0888l {
    ...
    /* renamed from: a */
    public static int m227a(Context context) {
        String str;
        PackageManager packageManager = context.getPackageManager();
        try {
            context.getResources().getString(C0884h.a.f479a);
        ...
        try {
            ...
            try {
                byte[] m231a = m231a(packageManager.getPackageInfo("com.android.vending", 64), f484a);
                if (m231a == null) {
                    str = "Google Play Store signature invalid.";
                } else {
                    if (m231a(packageInfo, m231a) != null) {
    ...
    /* renamed from: a */
    public static Intent m228a(Context context, int i, int i2) {
        if (i == 1 || i == 2) {
            return m230a(i2) ? m237d(context) ? C0891o.m242c("com.google.android.gms") : C0891o.m241b("com.google.android.apps.bazaar") : C0891o.m241b("com.google.android.gms");
        }
        if (i == 3) {
            return C0891o.m240a("com.google.android.gms");
        }
        if (i != 12) {
            return null;
        }
    ...
    /* renamed from: a */
    public static boolean m229a() {
        return f489f ? f490g : "user".equals(Build.TYPE);
    }

    /* renamed from: a */
    static boolean m230a(int i) {
        int m234b = m234b(i);
        return m234b != 0 ? m234b == 1 : !m229a();
    }

    /* renamed from: a */
    private static byte[] m231a(PackageInfo packageInfo, byte[]... bArr) {
        String str;
        try {
            CertificateFactory certificateFactory = CertificateFactory.getInstance("X509");
            if (packageInfo.signatures.length != 1) {
                str = "Package has more than one signature.";
            } else {
                try {
                    try {
                    ...
                    str = "Could not generate certificate.";
                }
            }
        } catch (CertificateException unused4) {
            str = "Could not get certificate instance.";
        }
        Log.w("GooglePlayServicesUtil", str);
        return null;
    }
    ...
    /* renamed from: a */
    private static byte[] m232a(String str) {
        try {
    ...
    /* renamed from: a */
    private static byte[][] m233a(byte[][]... bArr) {
        int i = 0;
        for (byte[][] bArr2 : bArr) {
            i += bArr2.length;
        }
    ...
    /* renamed from: b */
    private static int m234b(int i) {
        if (i == -1) {
            return 2;
        }
        return i;
    ...
    /* renamed from: b */
    public static void m235b(Context context) throws C0887k, C0886j {
        int m227a = m227a(context);
        if (m227a != 0) {
            Intent m228a = m228a(context, m227a, -1);
            Log.e("GooglePlayServicesUtil", "GooglePlayServices not available due to error " + m227a);
            if (m228a != null) {
                throw new C0887k(m227a, "Google Play Services not available", m228a);
            }
            throw new C0886j(m227a);
        }
    }

    /* renamed from: c */
    private static void m236c(Context context) {
    ...
    /* renamed from: d */
    private static boolean m237d(Context context) {
        if (f489f) {
            return f491h;
        }
        try {
            return m231a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f488e) != null;
