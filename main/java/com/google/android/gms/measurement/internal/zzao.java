...
public final class zzao extends zzmo {
    ...
    public final int zza(String str, String str2) {
        ...
        zzak();
        try {
            return m324e_().delete("conditional_properties", "app_id=? and name=?", new String[]{str, str2});
    ...
    public final long zza(String str) {
        ...
        zzak();
        try {
            return m324e_().delete("raw_events", "rowid in (select rowid from raw_events where app_id=? order by rowid desc limit -1 offset ?)", new String[]{str, String.valueOf(Math.max(0, Math.min(1000000, zze().zzb(str, zzbi.zzp))))});
        } catch (SQLiteException e) {
    ...
    /* renamed from: b_ */
    public final long m321b_() {
        Cursor cursor = null;
        try {
            try {
                cursor = m324e_().rawQuery("select rowid from raw_events order by rowid desc limit 1;", null);
    ...
    public final long zza(zzfi.zzj zzjVar) throws IOException {
        ...
        try {
            m324e_().insertWithOnConflict("raw_events_metadata", null, contentValues, 4);
            return zza2;
        } catch (SQLiteException e) {
    ...
    public final long zzb(String str, String str2) {
        ...
        zzt();
        zzak();
        SQLiteDatabase m324e_ = m324e_();
        m324e_.beginTransaction();
        long j = 0;
        try {
            try {
                ...
                if (zza2 == -1) {
                    ...
                    if (m324e_.insertWithOnConflict("app2", null, contentValues, 5) == -1) {
    ...
    /* renamed from: c_ */
    public final long m322c_() {
        return zza("select max(bundle_end_timestamp) from queue", (String[]) null, 0L);
    }

    /* renamed from: d_ */
    public final long m323d_() {
    ...
    private final long zzb(String str, String[] strArr) {
        ...
        try {
            try {
                Cursor rawQuery = m324e_().rawQuery(str, strArr);
    ...
    private final long zza(String str, String[] strArr, long j) {
        ...
        try {
            try {
                cursor = m324e_().rawQuery(str, strArr);
                if (cursor.moveToFirst()) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: e_ */
    public final SQLiteDatabase m324e_() {
        zzt();
        try {
    ...
    */
    public final android.os.Bundle zzc(java.lang.String r8) {
        /*
            ...
            r7.zzak()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r7.m324e_()     // Catch: java.lang.Throwable -> Lbe android.database.sqlite.SQLiteException -> Lc0
        ...
        L30:
            ...
            r7.mo326g_()     // Catch: android.database.sqlite.SQLiteException -> Lbc java.lang.Throwable -> Ld5
    ...
    */
    public final android.util.Pair<com.google.android.gms.internal.measurement.zzfi.zze, java.lang.Long> zza(java.lang.String r8, java.lang.Long r9) {
        /*
            ...
            r7.zzak()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r7.m324e_()     // Catch: java.lang.Throwable -> L79 android.database.sqlite.SQLiteException -> L7b
    ...
    */
    public final com.google.android.gms.measurement.internal.zzaq zze(java.lang.String r12) {
        /*
            ...
            r11.zzak()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r11.m324e_()     // Catch: java.lang.Throwable -> L6e android.database.sqlite.SQLiteException -> L70
    ...
    public final zzap zza(long j, String str, long j2, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        try {
            try {
                SQLiteDatabase m324e_ = m324e_();
                Cursor query = m324e_.query("apps", new String[]{"day", "daily_events_count", "daily_public_events_count", "daily_conversions_count", "daily_error_events_count", "daily_realtime_events_count"}, "app_id=?", new String[]{str}, null, null, null);
                ...
                m324e_.update("apps", contentValues, "app_id=?", strArr);
                if (query != null) {
                    query.close();
                }
                return zzapVar;
    ...
    */
    public final com.google.android.gms.measurement.internal.zzne zze(java.lang.String r19, java.lang.String r20) {
        /*
            ...
            r18.zzak()
            r9 = 0
            android.database.sqlite.SQLiteDatabase r10 = r18.m324e_()     // Catch: java.lang.Throwable -> L86 android.database.sqlite.SQLiteException -> L8a
    ...
    */
    private final <T> T zza(java.lang.String r3, java.lang.String[] r4, com.google.android.gms.measurement.internal.zzar<T> r5) {
        /*
            r2 = this;
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r2.m324e_()     // Catch: java.lang.Throwable -> L2e android.database.sqlite.SQLiteException -> L30
    ...
    */
    public final java.lang.String zza(long r5) {
        /*
            ...
            r4.zzak()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r4.m324e_()     // Catch: java.lang.Throwable -> L40 android.database.sqlite.SQLiteException -> L42
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String m325f_() {
        /*
            r6 = this;
            android.database.sqlite.SQLiteDatabase r0 = r6.m324e_()
            r1 = 0
        ...
        L44:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzao.m325f_():java.lang.String");
    }
    ...
    */
    ...
    public final List<zzmh> zzh(String str) {
        ...
        try {
            try {
                cursor = m324e_().query("trigger_uris", new String[]{"trigger_uri", "timestamp_millis", "source"}, "app_id=?", new String[]{str}, null, null, "rowid", null);
                if (!cursor.moveToFirst()) {
                    if (cursor != null) {
                        cursor.close();
                    }
    ...
    public final List<zzne> zzi(String str) {
        ...
        try {
            try {
                cursor = m324e_().query("user_attributes", new String[]{"name", "origin", "set_timestamp", "value"}, "app_id=?", new String[]{str}, null, null, "rowid", "1000");
                if (!cursor.moveToFirst()) {
                    if (cursor != null) {
                        cursor.close();
                    }
    ...
    */
    ...
    public final Map<Integer, zzfi.zzl> zzj(String str) {
        ...
        try {
            try {
                Cursor query = m324e_().query("audience_filter_values", new String[]{"audience_id", "current_results"}, "app_id=?", new String[]{str}, null, null, null);
                if (!query.moveToFirst()) {
    ...
    public final Map<Integer, List<zzew.zzb>> zzk(String str) {
        ...
        try {
            try {
                Cursor query = m324e_().query("event_filters", new String[]{"audience_id", "data"}, "app_id=?", new String[]{str}, null, null, null);
                if (!query.moveToFirst()) {
    ...
    public final Map<Integer, List<zzew.zzb>> zzf(String str, String str2) {
        ...
        try {
            try {
                Cursor query = m324e_().query("event_filters", new String[]{"audience_id", "data"}, "app_id=? AND event_name=?", new String[]{str, str2}, null, null, null);
                if (!query.moveToFirst()) {
                    Map<Integer, List<zzew.zzb>> emptyMap = Collections.emptyMap();
                    if (query != null) {
                        query.close();
    ...
    public final Map<Integer, List<zzew.zze>> zzg(String str, String str2) {
        ...
        try {
            try {
                Cursor query = m324e_().query("property_filters", new String[]{"audience_id", "data"}, "app_id=? AND property_name=?", new String[]{str, str2}, null, null, null);
                if (!query.moveToFirst()) {
    ...
    public final Map<Integer, List<Integer>> zzl(String str) {
        ...
        try {
            try {
                Cursor rawQuery = m324e_().rawQuery("select audience_id, filter_id from event_filters where app_id = ? and session_scoped = 1 UNION select audience_id, filter_id from property_filters where app_id = ? and session_scoped = 1;", new String[]{str, str});
                if (!rawQuery.moveToFirst()) {
    ...
    public final void zza(List<Long> list) {
        ...
        if (zzan()) {
            ...
            try {
                m324e_().execSQL("UPDATE queue SET retry_count = IFNULL(retry_count, 0) + 1 WHERE rowid IN " + str + " AND (retry_count IS NULL OR retry_count < 2147483647)");
            } catch (SQLiteException e) {
    ...
    public final void zzv() {
        ...
        if (zzan()) {
            ...
            if (Math.abs(elapsedRealtime - zza2) > zzbi.zzy.zza(null).longValue()) {
                ...
                zzt();
                zzak();
                if (!zzan() || (delete = m324e_().delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{String.valueOf(zzb().currentTimeMillis()), String.valueOf(zzaf.zzm())})) <= 0) {
                    return;
                }
    ...
    public final void zzh(String str, String str2) {
        ...
        zzak();
        try {
            m324e_().delete("user_attributes", "app_id=? and name=?", new String[]{str, str2});
        } catch (SQLiteException e) {
    ...
    public final void zza(String str, List<zzew.zza> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            zzew.zza.C3238zza zzby = list.get(i).zzby();
            if (zzby.zza() != 0) {
        ...
        try {
            ...
            zzt();
            Preconditions.checkNotEmpty(str);
            SQLiteDatabase m324e_2 = m324e_();
            m324e_2.delete("property_filters", "app_id=?", new String[]{str});
            m324e_2.delete("event_filters", "app_id=?", new String[]{str});
                            ...
                            while (true) {
                                if (it2.hasNext()) {
                                    ...
                                    if (!z) {
                                        ...
                                        zzt();
                                        Preconditions.checkNotEmpty(str);
                                        SQLiteDatabase m324e_3 = m324e_();
                                        m324e_3.delete("property_filters", "app_id=? and audience_id=?", new String[]{str, String.valueOf(zza5)});
                                        m324e_3.delete("event_filters", "app_id=? and audience_id=?", new String[]{str, String.valueOf(zza5)});
                                    }
                                }
                            }
                        }
    ...
    public final void zza(zzh zzhVar) {
        ...
        try {
            SQLiteDatabase m324e_ = m324e_();
            if (m324e_.update("apps", contentValues, "app_id = ?", new String[]{zzx}) == 0 && m324e_.insertWithOnConflict("apps", null, contentValues, 5) == -1) {
    ...
    public final void zza(String str, zzih zzihVar) {
        ...
        try {
            if (m324e_().insertWithOnConflict("consent_settings", null, contentValues, 5) == -1) {
    ...
    public final void zza(zzbc zzbcVar) {
        ...
        try {
            if (m324e_().insertWithOnConflict("events", null, contentValues, 5) == -1) {
    ...
    private final void zza(String str, String str2, ContentValues contentValues) {
        try {
            ...
            if (m324e_.update(str, contentValues, str2 + " = ?", new String[]{r1}) == 0 && m324e_.insertWithOnConflict(str, null, contentValues, 5) == -1) {
    ...
    private final boolean zzb(String str, List<Integer> list) {
        ...
        try {
            ...
            return m324e_.delete("audience_filter_values", sb.toString(), new String[]{str, Integer.toString(max)}) > 0;
        } catch (SQLiteException e) {
    ...
    public final boolean zza(zzfi.zzj zzjVar, boolean z) {
        ...
        try {
            byte[] zzb2 = mo326g_().zzb(zzjVar.zzbv());
            ...
            try {
                if (m324e_().insert("queue", null, contentValues) != -1) {
                    return true;
                }
    ...
    private final boolean zza(String str, int i, zzew.zzb zzbVar) {
        ...
        try {
            if (m324e_().insertWithOnConflict("event_filters", null, contentValues, 5) != -1) {
                return true;
            }
    ...
    private final boolean zza(String str, int i, zzew.zze zzeVar) {
        ...
        contentValues.put("data", zzbv);
        try {
            if (m324e_().insertWithOnConflict("property_filters", null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final boolean zza(zzaz zzazVar, long j, boolean z) {
        ...
        byte[] zzbv = mo326g_().zza(zzazVar).zzbv();
        ContentValues contentValues = new ContentValues();
        ...
        try {
            if (m324e_().insert("raw_events", null, contentValues) != -1) {
                return true;
            }
    ...
    public final boolean zza(String str, zzmh zzmhVar) {
        ...
        try {
            if (m324e_().insert("trigger_uris", null, contentValues) != -1) {
                return true;
            }
    ...
    public final boolean zza(String str, Long l, long j, zzfi.zze zzeVar) {
        ...
        try {
            if (m324e_().insertWithOnConflict("main_event_params", null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final boolean zza(zzad zzadVar) {
        ...
        try {
            if (m324e_().insertWithOnConflict("conditional_properties", null, contentValues, 5) == -1) {
    ...
    public final boolean zza(String str, Bundle bundle) {
        zzt();
        zzak();
        byte[] zzbv = mo326g_().zza(new zzaz(this.zzu, "", str, "dep", 0L, 0L, bundle)).zzbv();
        ...
        try {
            if (m324e_().insertWithOnConflict("default_event_params", null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final boolean zza(zzne zzneVar) {
        ...
        try {
            if (m324e_().insertWithOnConflict("user_attributes", null, contentValues, 5) == -1) {
