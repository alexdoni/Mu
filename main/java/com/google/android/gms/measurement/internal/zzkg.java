    ...
    public final byte[] zza(zzbg zzbgVar, String str) {
        ...
        try {
            ...
            if (zzneVar == null || zzneVar.zze == null) {
                zzne zzneVar2 = new zzne(zzx, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_lte", zzb().currentTimeMillis(), 0L);
                zzi2.add(zzneVar2);
                zzh().zza(zzneVar2);
            }
            ...
            for (int i = 0; i < zzi2.size(); i++) {
                ...
                mo326g_().zza(zzb3, zzi2.get(i).zze);
            ...
            zzh().zzw();
            try {
                return mo326g_().zzb(((zzfi.zzi) ((com.google.android.gms.internal.measurement.zzix) zzaVar4.zzab())).zzbv());
            } catch (IOException e) {
