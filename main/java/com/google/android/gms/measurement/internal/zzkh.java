...
public final class zzkh extends zze {
    ...
    public final void zza(zzki zzkiVar, zzki zzkiVar2, long j, boolean z, Bundle bundle) {
        ...
        if (z3) {
            ...
            String str = zzkiVar.zze ? "app" : DebugKt.DEBUG_PROPERTY_VALUE_AUTO;
    ...
    public final void zza(Activity activity, String str, String str2) {
        ...
        zzj().zzp().zza("Setting current screen to name, class", str == null ? JsonSerializer.Null : str, str2);
    ...
    public final void zza(Bundle bundle, long j) {
        ...
        synchronized (this.zzj) {
            ...
            zzj().zzp().zza("Logging screen view with name, class", str == null ? JsonSerializer.Null : str, str3 == null ? JsonSerializer.Null : str3);
