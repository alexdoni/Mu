...
public final class zzng implements zznh {
    ...
    static {
        ...
        zzaj = zza2.zza("measurement.upload.max_bundle_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzas = zza2.zza("measurement.upload.max_batch_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
