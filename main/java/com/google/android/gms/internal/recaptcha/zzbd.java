...
public final class zzbd extends GmsClient<zzaf> {
    public zzbd(Context context, Looper looper, ClientSettings clientSettings, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
        super(context, looper, CallCode.HTTP_RESET, clientSettings, connectionCallbacks, onConnectionFailedListener);
    }
    ...
    public final Feature[] getApiFeatures() {
        return com.google.android.gms.recaptcha.zzc.zze;
    }
