...
final class zzsb extends zzpk<Long> implements RandomAccess, zzro, zzsv {
    private static final zzsb zza;
    private long[] zzb;
    private int zzc;

    static {
        zzsb zzsbVar = new zzsb(new long[0], 0);
        zza = zzsbVar;
        zzsbVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        zza();
        zzrp.zze(collection);
        if (!(collection instanceof zzsb)) {
            return super.addAll(collection);
        }
        zzsb zzsbVar = (zzsb) collection;
        int i = zzsbVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzsbVar.zzb, 0, this.zzb, this.zzc, zzsbVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzsbVar.zzc) {
            return false;
        }
        long[] jArr = zzsbVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzro zzd(int i) {
        if (i >= this.zzc) {
            return new zzsb(Arrays.copyOf(this.zzb, i), this.zzc);
        }
