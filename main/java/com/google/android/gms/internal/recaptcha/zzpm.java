...
final class zzpm extends zzpk<Boolean> implements RandomAccess, zzro, zzsv {
    private static final zzpm zza;
    private boolean[] zzb;
    private int zzc;

    static {
        zzpm zzpmVar = new zzpm(new boolean[0], 0);
        zza = zzpmVar;
        zzpmVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Boolean> collection) {
        zza();
        zzrp.zze(collection);
        if (!(collection instanceof zzpm)) {
            return super.addAll(collection);
        }
        zzpm zzpmVar = (zzpm) collection;
        int i = zzpmVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzpmVar.zzb, 0, this.zzb, this.zzc, zzpmVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzpmVar.zzc) {
            return false;
        }
        boolean[] zArr = zzpmVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzro zzd(int i) {
        if (i >= this.zzc) {
            return new zzpm(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    private zzpm(boolean[] zArr, int i) {
        this.zzb = zArr;
        this.zzc = i;
    }
