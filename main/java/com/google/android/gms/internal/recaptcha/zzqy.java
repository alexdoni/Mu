...
final class zzqy extends zzpk<Float> implements RandomAccess, zzro, zzsv {
    private static final zzqy zza;
    private float[] zzb;
    private int zzc;

    static {
        zzqy zzqyVar = new zzqy(new float[0], 0);
        zza = zzqyVar;
        zzqyVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        zza();
        zzrp.zze(collection);
        if (!(collection instanceof zzqy)) {
            return super.addAll(collection);
        }
        zzqy zzqyVar = (zzqy) collection;
        int i = zzqyVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzqyVar.zzb, 0, this.zzb, this.zzc, zzqyVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzqyVar.zzc) {
            return false;
        }
        float[] fArr = zzqyVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzro zzd(int i) {
        if (i >= this.zzc) {
            return new zzqy(Arrays.copyOf(this.zzb, i), this.zzc);
        }
