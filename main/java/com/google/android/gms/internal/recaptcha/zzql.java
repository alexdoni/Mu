...
final class zzql extends zzpk<Double> implements RandomAccess, zzro, zzsv {
    private static final zzql zza;
    private double[] zzb;
    private int zzc;

    static {
        zzql zzqlVar = new zzql(new double[0], 0);
        zza = zzqlVar;
        zzqlVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        zza();
        zzrp.zze(collection);
        if (!(collection instanceof zzql)) {
            return super.addAll(collection);
        }
        zzql zzqlVar = (zzql) collection;
        int i = zzqlVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzqlVar.zzb, 0, this.zzb, this.zzc, zzqlVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    @Override // com.google.android.gms.internal.recaptcha.zzpk, java.util.AbstractList, java.util.Collection, java.util.List
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzqlVar.zzc) {
            return false;
        }
        double[] dArr = zzqlVar.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzrp.zzc(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final /* bridge */ /* synthetic */ zzro zzd(int i) {
        if (i >= this.zzc) {
            return new zzql(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    private zzql(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
