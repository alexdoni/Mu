...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0935R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0935R.styleable.MaterialButtonToggleGroup, i, C0935R.style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
        setSingleSelection(obtainStyledAttributes.getBoolean(C0935R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = obtainStyledAttributes.getResourceId(C0935R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
