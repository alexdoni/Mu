...
public class MaterialCheckBox extends AppCompatCheckBox {
    private static final int DEF_STYLE_RES = C0935R.style.Widget_MaterialComponents_CompoundButton_CheckBox;
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0935R.attr.checkboxStyle);
    }
    ...
    */
    public MaterialCheckBox(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C0935R.styleable.MaterialCheckBox
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r10 = com.google.android.material.C0935R.styleable.MaterialCheckBox_buttonTint
        ...
        L2a:
            int r8 = com.google.android.material.C0935R.styleable.MaterialCheckBox_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int color = MaterialColors.getColor(this, C0935R.attr.colorControlActivated);
            int color2 = MaterialColors.getColor(this, C0935R.attr.colorSurface);
            int color3 = MaterialColors.getColor(this, C0935R.attr.colorOnSurface);
