...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C0935R.style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    public MaterialRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0935R.attr.radioButtonStyle);
    }
    ...
    */
    public MaterialRadioButton(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            ...
            int[] r2 = com.google.android.material.C0935R.styleable.MaterialRadioButton
            r7 = 0
            int[] r5 = new int[r7]
            r1 = r8
            r3 = r9
            android.content.res.TypedArray r8 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r9 = com.google.android.material.C0935R.styleable.MaterialRadioButton_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int color2 = MaterialColors.getColor(this, C0935R.attr.colorOnSurface);
            int color3 = MaterialColors.getColor(this, C0935R.attr.colorSurface);
