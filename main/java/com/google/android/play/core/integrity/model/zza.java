...
public final class zza {
    ...
    static {
        ...
        hashMap.put(-4, "No active account found in the Play Store app.\nAsk the user to authenticate in Play Store.\n");
        ...
        hashMap2.put(-6, "GOOGLE_PLAY_SERVICES_NOT_AVAILABLE");
    ...
    public static String zza(int i) {
        ...
        sb.append(str);
        sb.append(" (https://developer.android.com/reference/com/google/android/play/core/integrity/model/IntegrityErrorCode.html#");
        sb.append(str2);
        sb.append(")");
        return sb.toString();
    }
