...
public abstract class Striped<L> {
    ...
    public static class SmallLazyStriped<L> extends PowerOfTwoStriped<L> {
        ...
        public L getAt(int i) {
            ...
            while (!UByte$$ExternalSyntheticBackport0.m1411m(this.locks, i, arrayReference, arrayReference2)) {
        ...
        private void drainQueue() {
            while (true) {
                ...
                UByte$$ExternalSyntheticBackport0.m1411m(this.locks, arrayReference.index, arrayReference, (Object) null);
            }
        }
