...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    /* loaded from: classes2.dex */
    public class C13831 extends AbstractGraph<N> {
        C13831() {
        }
        ...
        public /* bridge */ /* synthetic */ Iterable predecessors(Object obj) {
            return predecessors((C13831) obj);
        }
        ...
        public Set<EndpointPair<N>> edges() {
            ...
            return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractNetwork.1.1
                ...
                public boolean contains(@CheckForNull Object obj) {
                    ...
                    return C13831.this.isOrderingCompatible(endpointPair) && C13831.this.nodes().contains(endpointPair.nodeU()) && C13831.this.successors((C13831) endpointPair.nodeU()).contains(endpointPair.nodeV());
                }
            };
        }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m411of((Object) e));
    }
