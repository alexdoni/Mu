...
public final class ElementOrder<T> {
    ...
    public String toString() {
        MoreObjects.ToStringHelper add = MoreObjects.toStringHelper(this).add(ShareConstants.MEDIA_TYPE, this.type);
        Comparator<T> comparator = this.comparator;
        if (comparator != null) {
    ...
    public <K extends T, V> Map<K, V> createMap(int i) {
        int i2 = C13941.$SwitchMap$com$google$common$graph$ElementOrder$Type[this.type.ordinal()];
        if (i2 == 1) {
