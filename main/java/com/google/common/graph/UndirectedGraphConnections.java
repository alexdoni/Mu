...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* renamed from: of */
    public static <N, V> UndirectedGraphConnections<N, V> m479of(ElementOrder<N> elementOrder) {
        int i = C14121.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
