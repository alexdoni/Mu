...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m341on(JwtParser.SEPARATOR_CHAR);
    private static final Joiner DOT_JOINER = Joiner.m334on(JwtParser.SEPARATOR_CHAR);
    ...
    static {
        ...
        CharMatcher mo333or = CharMatcher.inRange('a', 'z').mo333or(CharMatcher.inRange('A', Matrix.MATRIX_TYPE_ZERO));
        LETTER_MATCHER = mo333or;
        PART_CHAR_MATCHER = inRange.mo333or(mo333or).mo333or(anyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m336of(PublicSuffixType.REGISTRY));
    }
