...
public final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f599C1 = -862048943;

    /* renamed from: C2 */
    private static final int f600C2 = 461845907;
    ...
    public static int mixK1(int i) {
        return Integer.rotateLeft(i * f599C1, 15) * f600C2;
    }
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            ...
            this.length += i;
            if (i3 >= 32) {
                this.f601h1 = Murmur3_32HashFunction.mixH1(this.f601h1, Murmur3_32HashFunction.mixK1((int) j4));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            int mixK1 = this.f601h1 ^ Murmur3_32HashFunction.mixK1((int) this.buffer);
            this.f601h1 = mixK1;
