...
public final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f595C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f596C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            long mixK1 = mixK1(j) ^ this.f597h1;
            this.f597h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            long j3 = this.f598h2;
            this.f597h1 = ((rotateLeft + j3) * 5) + 1390208809;
            long mixK2 = mixK2(j2) ^ j3;
            this.f598h2 = mixK2;
            this.f598h2 = ((Long.rotateLeft(mixK2, 31) + this.f597h1) * 5) + 944331445;
        }
        ...
        protected void processRemaining(ByteBuffer byteBuffer) {
            ...
            switch (byteBuffer.remaining()) {
                case 1:
                    ...
                    this.f597h1 ^= mixK1(j7);
                    this.f598h2 ^= mixK2(j15);
                    return;
                case 2:
                    j2 = 0;
        ...
        protected HashCode makeHash() {
            ...
            int i = this.length;
            long j2 = j ^ i;
            long j3 = this.f598h2 ^ i;
            long j4 = j2 + j3;
            this.f597h1 = j4;
            this.f598h2 = j3 + j4;
            this.f597h1 = fmix64(j4);
            long fmix64 = fmix64(this.f598h2);
            long j5 = this.f597h1 + fmix64;
            this.f597h1 = j5;
            this.f598h2 = fmix64 + j5;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f597h1).putLong(this.f598h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f595C1, 31) * f596C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f596C2, 33) * f595C1;
        }
    }
}
