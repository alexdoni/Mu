...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f560f;

        /* renamed from: g */
        private final Function<B, C> f561g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f561g = (Function) Preconditions.checkNotNull(function);
            this.f560f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        @ParametricNullness
        public C apply(@ParametricNullness A a2) {
            return (C) this.f561g.apply(this.f560f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f560f.equals(functionComposition.f560f) && this.f561g.equals(functionComposition.f561g);
        }

        public int hashCode() {
            return this.f560f.hashCode() ^ this.f561g.hashCode();
        }

        public String toString() {
            String valueOf = String.valueOf(this.f561g);
            String valueOf2 = String.valueOf(this.f560f);
