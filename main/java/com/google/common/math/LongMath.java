...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, 16, 16, 16, Ascii.f555SI, Ascii.f555SI, Ascii.f555SI, Ascii.f555SI, Ascii.f556SO, Ascii.f556SO, Ascii.f556SO, Ascii.f546CR, Ascii.f546CR, Ascii.f546CR, Ascii.f548FF, Ascii.f548FF, Ascii.f548FF, Ascii.f548FF, 11, 11, 11, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, CallCode.HTTP_PARTIAL, CipherSuite.TLS_PSK_WITH_AES_256_GCM_SHA384, CipherSuite.TLS_DHE_PSK_WITH_3DES_EDE_CBC_SHA, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, CipherSuite.TLS_PSK_WITH_AES_256_GCM_SHA384, CipherSuite.TLS_PSK_WITH_3DES_EDE_CBC_SHA, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    */
    public static long divide(long r9, long r11, java.math.RoundingMode r13) {
        ...
        L10:
            ...
            r10 = 1
            r9 = r9 | r10
            int[] r7 = com.google.common.math.LongMath.C14541.$SwitchMap$java$math$RoundingMode
            int r8 = r13.ordinal()
            r7 = r7[r8]
            r8 = 0
            switch(r7) {
    ...
    private enum MillerRabinTester {
        ...
        /* synthetic */ MillerRabinTester(C14541 c14541) {
            this();
        }
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        switch (C14541.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 8:
                ...
                int i = C14541.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 6) {
                    return j >= 0 ? d2 : d;
                }
                if (i == 7) {
