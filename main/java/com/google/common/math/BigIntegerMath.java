...
public final class BigIntegerMath {
    ...
    public static int log2(BigInteger bigInteger, RoundingMode roundingMode) {
        ...
        switch (C14501.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    */
    public static int log10(java.math.BigInteger r7, java.math.RoundingMode r8) {
        ...
        L5f:
            r2 = r4
        L60:
            int[] r3 = com.google.common.math.BigIntegerMath.C14501.$SwitchMap$java$math$RoundingMode
            int r8 = r8.ordinal()
            r8 = r3[r8]
            switch(r8) {
                case 1: goto L94;
