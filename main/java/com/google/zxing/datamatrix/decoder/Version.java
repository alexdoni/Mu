...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        return new Version[]{new Version(1, 10, 10, 8, 8, new ECBlocks(i3, new ECB(i2, 3))), new Version(2, 12, 12, 10, 10, new ECBlocks(7, new ECB(i2, i3))), version, new Version(4, 16, 16, 14, 14, new ECBlocks(i5, new ECB(i2, i5))), new Version(5, 18, 18, 16, 16, new ECBlocks(14, new ECB(i2, i6))), new Version(6, 20, 20, 18, 18, new ECBlocks(i6, new ECB(i2, 22))), version2, new Version(8, 24, 24, 22, 22, new ECBlocks(24, new ECB(i2, i8))), new Version(9, 26, 26, 24, 24, new ECBlocks(28, new ECB(i2, 44))), new Version(10, 32, 32, 14, 14, new ECBlocks(i8, new ECB(i2, i9))), new Version(11, 36, 36, 16, 16, new ECBlocks(42, new ECB(i2, 86))), new Version(12, 40, 40, 18, 18, new ECBlocks(48, new ECB(i2, 114))), new Version(13, 44, 44, 20, 20, new ECBlocks(i10, new ECB(i2, CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA))), new Version(14, 48, 48, 22, 22, new ECBlocks(i11, new ECB(i2, CipherSuite.TLS_PSK_WITH_AES_128_CBC_SHA256))), new Version(15, 52, 52, 24, 24, new ECBlocks(42, new ECB(i4, 102))), new Version(16, 64, 64, 14, 14, new ECBlocks(i10, new ECB(i4, CipherSuite.TLS_PSK_WITH_AES_128_CBC_SHA))), new Version(17, 72, 72, 16, 16, new ECBlocks(i8, new ECB(4, 92))), new Version(18, 80, 80, 18, 18, new ECBlocks(48, new ECB(4, 114))), new Version(19, 88, 88, 20, 20, new ECBlocks(i10, new ECB(4, CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA))), new Version(20, 96, 96, 22, 22, new ECBlocks(i11, new ECB(4, CipherSuite.TLS_PSK_WITH_AES_128_CBC_SHA256))), new Version(21, 104, 104, 24, 24, new ECBlocks(i10, new ECB(i7, CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA))), new Version(22, 120, 120, 18, 18, new ECBlocks(i11, new ECB(i7, CipherSuite.TLS_PSK_WITH_AES_256_CBC_SHA384))), new Version(23, CipherSuite.TLS_RSA_WITH_CAMELLIA_256_CBC_SHA, CipherSuite.TLS_RSA_WITH_CAMELLIA_256_CBC_SHA, 20, 20, new ECBlocks(i9, new ECB(i, CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384))), new Version(24, CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA, CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA, 22, 22, new ECBlocks(i9, new ECB(i, CipherSuite.TLS_RSA_WITH_AES_128_GCM_SHA256), new ECB(i4, CipherSuite.TLS_DH_anon_WITH_SEED_CBC_SHA))), new Version(25, 8, 18, 6, 16, new ECBlocks(7, ecb)), new Version(26, 8, 32, 6, 14, new ECBlocks(11, ecb2)), new Version(27, 12, 26, 10, 24, new ECBlocks(14, ecb3)), new Version(28, 12, 36, 10, 16, new ECBlocks(i6, new ECB(i2, 22))), new Version(29, 16, 36, 14, 16, new ECBlocks(24, new ECB(i2, 32))), new Version(30, 16, 48, 14, 22, new ECBlocks(28, new ECB(i2, 49)))};
    }
}
