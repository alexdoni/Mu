...
public final class Decoder {
    ...
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", "2", "3", "4", "5", "6", "7", Constants.SDK_LOGIN_TYPE_HUAWEI, "9", ",", ".", "CTRL_UL", "CTRL_US"};
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C17781 {
    ...
    private static String getCharacter(Table table, int i) {
        int i2 = C17781.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
