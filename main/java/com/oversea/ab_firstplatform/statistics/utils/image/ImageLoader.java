...
import com.oversea.ab_firstplatform.statistics.utils.image.ImageSizeUtil;
...
public class ImageLoader {
    ...
    private void init(int i, Type type) {
        initBackThread();
        this.mLruCache = new LruCache<String, Bitmap>(((int) Runtime.getRuntime().maxMemory()) / 8) { // from class: com.oversea.ab_firstplatform.statistics.utils.image.ImageLoader.1
    ...
    private void initBackThread() {
        Thread thread = new Thread() { // from class: com.oversea.ab_firstplatform.statistics.utils.image.ImageLoader.2
            @Override // java.lang.Thread, java.lang.Runnable
            public void run() {
                Looper.prepare();
                ImageLoader.this.mPoolThreadHandler = new Handler() { // from class: com.oversea.ab_firstplatform.statistics.utils.image.ImageLoader.2.1
    ...
    public void loadImage(String str, ImageView imageView, boolean z) {
        ...
        if (this.mUIHandler == null) {
            this.mUIHandler = new Handler() { // from class: com.oversea.ab_firstplatform.statistics.utils.image.ImageLoader.3
                @Override // android.os.Handler
                public void handleMessage(Message message) {
    ...
    private Runnable buildTask(final String str, final ImageView imageView, final boolean z) {
        return new Runnable() { // from class: com.oversea.ab_firstplatform.statistics.utils.image.ImageLoader.4
