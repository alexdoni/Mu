...
public final class CancellationTokenSource implements Closeable {
            ...
            if (delay != -1) {
                this.scheduledCancellation = this.executor.schedule(new Runnable() { // from class: com.facebook.bolts.CancellationTokenSource$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        CancellationTokenSource.m1714cancelAfter$lambda6$lambda5(CancellationTokenSource.this);
                    }
                }, delay, timeUnit);
            }
            Unit unit = Unit.INSTANCE;
    ...
    public static final void m1714cancelAfter$lambda6$lambda5(CancellationTokenSource this$0) {
