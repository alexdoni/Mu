...
public class FileDownloadModel implements Parcelable {
    ...
    /* renamed from: ID */
    public static final String f718ID = "_id";
    ...
    public ContentValues toContentValues() {
        ...
        contentValues.put(f718ID, Integer.valueOf(getId()));
    ...
    public String toString() {
        return FileDownloadUtils.formatString("id[%d], url[%s], path[%s], status[%d], sofar[%s], total[%d], etag[%s], %s", Integer.valueOf(this.f719id), this.url, this.path, Integer.valueOf(this.status.get()), this.soFar, Long.valueOf(this.total), this.eTag, super.toString());
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeInt(this.f719id);
