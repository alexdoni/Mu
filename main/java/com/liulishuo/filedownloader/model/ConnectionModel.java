...
public class ConnectionModel {
    ...
    /* renamed from: ID */
    public static final String f716ID = "id";
    ...
    public ContentValues toContentValues() {
        ...
        contentValues.put("id", Integer.valueOf(this.f717id));
    ...
    public String toString() {
        return FileDownloadUtils.formatString("id[%d] index[%d] range[%d, %d) current offset(%d)", Integer.valueOf(this.f717id), Integer.valueOf(this.index), Long.valueOf(this.startOffset), Long.valueOf(this.endOffset), Long.valueOf(this.currentOffset));
    }
}
