...
import com.liulishuo.filedownloader.C2063R;
...
public class ForegroundServiceConfig {
    ...
    public Notification getNotification(Context context) {
        if (this.notification == null) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "build default notification", new Object[0]);
            }
    ...
    private Notification buildDefaultNotification(Context context) {
        String string = context.getString(C2063R.string.default_filedownloader_notification_title);
        String string2 = context.getString(C2063R.string.default_filedownloader_notification_content);
