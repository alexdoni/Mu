...
public class DownloadMgrInitialParams {
    ...
    public int getMaxNetworkThreadCount() {
        ...
        if (num != null) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "initial FileDownloader manager with the customize maxNetworkThreadCount: %d", num);
            }
    ...
    public FileDownloadDatabase createDatabase() {
        ...
        if (customMake != null) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "initial FileDownloader manager with the customize database: %s", customMake);
            }
            return customMake;
        }
        return createDefaultDatabase();
    ...
    public FileDownloadHelper.OutputStreamCreator createOutputStreamCreator() {
        ...
        if (outputStreamCreator != null) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "initial FileDownloader manager with the customize output stream: %s", outputStreamCreator);
            }
    ...
    public FileDownloadHelper.ConnectionCreator createConnectionCreator() {
        ...
        if (connectionCreator != null) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "initial FileDownloader manager with the customize connection creator: %s", connectionCreator);
            }
    ...
    public FileDownloadHelper.ConnectionCountAdapter createConnectionCountAdapter() {
        ...
        if (connectionCountAdapter != null) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "initial FileDownloader manager with the customize connection count adapter: %s", connectionCountAdapter);
            }
    ...
    public FileDownloadHelper.IdGenerator createIdGenerator() {
        ...
        if (idGenerator != null) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "initial FileDownloader manager with the customize id generator: %s", idGenerator);
            }
            return idGenerator;
        }
        return createDefaultIdGenerator();
    ...
    public ForegroundServiceConfig createForegroundServiceConfig() {
        ...
        if (foregroundServiceConfig != null) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "initial FileDownloader manager with the customize foreground service config: %s", foregroundServiceConfig);
            }
