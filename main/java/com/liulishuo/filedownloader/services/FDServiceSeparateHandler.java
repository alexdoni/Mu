...
import com.liulishuo.filedownloader.p010i.IFileDownloadIPCCallback;
...
public class FDServiceSeparateHandler extends IFileDownloadIPCService.Stub implements MessageSnapshotFlow.MessageReceiver, IFileDownloadServiceHandler {
        ...
        for (int i = 0; i < beginBroadcast; i++) {
            try {
                try {
                    ...
                    FileDownloadLog.m593e(this, e, "callback error", new Object[0]);
    ...
    @Override // com.liulishuo.filedownloader.p010i.IFileDownloadIPCService
