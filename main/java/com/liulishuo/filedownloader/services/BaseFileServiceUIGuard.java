...
public abstract class BaseFileServiceUIGuard<CALLBACK extends Binder, INTERFACE extends IInterface> implements IFileDownloadServiceProxy, ServiceConnection {
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        if (FileDownloadLog.NEED_LOG) {
            FileDownloadLog.m591d(this, "onServiceConnected %s %s", componentName, this.service);
        }
        try {
    ...
    public void onServiceDisconnected(ComponentName componentName) {
        if (FileDownloadLog.NEED_LOG) {
            FileDownloadLog.m591d(this, "onServiceDisconnected %s %s", componentName, this.service);
        }
        releaseConnect(true);
    }
    ...
    private void releaseConnect(boolean z) {
        ...
        if (FileDownloadLog.NEED_LOG) {
            FileDownloadLog.m591d(this, "release connect resources %s", this.service);
        }
        this.service = null;
    ...
    public void bindStartByContext(Context context, Runnable runnable) {
        ...
        if (FileDownloadLog.NEED_LOG) {
            FileDownloadLog.m591d(this, "bindStartByContext %s", context.getClass().getSimpleName());
        }
        ...
        if (this.runServiceForeground) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "start foreground service", new Object[0]);
            }
    ...
    public void unbindByContext(Context context) {
        if (this.bindContexts.contains(context)) {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "unbindByContext %s", context);
            }
