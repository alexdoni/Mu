    ...
    public static class LaunchTaskPool {
        ...
        public void expire(FileDownloadListener fileDownloadListener) {
            if (fileDownloadListener == null) {
                FileDownloadLog.m596w(this, "want to expire by listener, but the listener provided is null", new Object[0]);
                return;
            }
            ...
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "expire %d tasks with listener[%s]", Integer.valueOf(arrayList.size()), fileDownloadListener);
            }
        ...
        public void expireAll() {
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "expire %d tasks", Integer.valueOf(this.mWorkQueue.size()));
            }
