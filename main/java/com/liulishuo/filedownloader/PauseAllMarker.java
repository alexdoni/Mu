...
import com.liulishuo.filedownloader.p010i.IFileDownloadIPCService;
...
public class PauseAllMarker implements Handler.Callback {
    ...
    public static void createMarker() {
        ...
        if (markerFile2.exists()) {
            FileDownloadLog.m596w(PauseAllMarker.class, "marker file " + markerFile2.getAbsolutePath() + " exists", new Object[0]);
            return;
        }
        try {
            FileDownloadLog.m591d(PauseAllMarker.class, "create marker file" + markerFile2.getAbsolutePath() + " " + markerFile2.createNewFile(), new Object[0]);
        } catch (IOException e) {
            FileDownloadLog.m592e(PauseAllMarker.class, "create marker file failed", e);
        }
    }
    ...
    public static void clearMarker() {
        File markerFile2 = markerFile();
        if (markerFile2.exists()) {
            FileDownloadLog.m591d(PauseAllMarker.class, "delete marker file " + markerFile2.delete(), new Object[0]);
        }
    }
        ...
        try {
            if (isMarked()) {
                try {
                    ...
                    FileDownloadLog.m593e(this, e, "pause all failed", new Object[0]);
                }
            }
