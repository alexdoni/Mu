...
public class DownloadTask implements BaseDownloadTask, BaseDownloadTask.IRunningTask, DownloadTaskHunter.ICaptureTask {
    ...
    public BaseDownloadTask setPath(String str, boolean z) {
        ...
        if (FileDownloadLog.NEED_LOG) {
            FileDownloadLog.m591d(this, "setPath %s", str);
        }
    ...
    public BaseDownloadTask setListener(FileDownloadListener fileDownloadListener) {
        ...
        if (FileDownloadLog.NEED_LOG) {
            FileDownloadLog.m591d(this, "setListener %s", fileDownloadListener);
        }
        return this;
    }
    ...
    public BaseDownloadTask setTag(Object obj) {
        this.mTag = obj;
        if (FileDownloadLog.NEED_LOG) {
            FileDownloadLog.m591d(this, "setTag %s", obj);
        }
        return this;
    }
    ...
    public boolean reuse() {
        if (isRunning()) {
            FileDownloadLog.m596w(this, "This task[%d] is running, if you want start the same task, please create a new one by FileDownloader#create", Integer.valueOf(getId()));
            return false;
        }
        this.mAttachKey = 0;
    ...
    @Override // com.liulishuo.filedownloader.BaseDownloadTask.IRunningTask
    /* renamed from: is */
    public boolean mo589is(int i) {
        return getId() == i;
    }

    @Override // com.liulishuo.filedownloader.BaseDownloadTask.IRunningTask
    /* renamed from: is */
    public boolean mo590is(FileDownloadListener fileDownloadListener) {
    ...
    public static final class InQueueTaskImpl implements BaseDownloadTask.InQueueTask {
        ...
        public int enqueue() {
            ...
            if (FileDownloadLog.NEED_LOG) {
                FileDownloadLog.m591d(this, "add the task[%d] to the queue", Integer.valueOf(id));
            }
