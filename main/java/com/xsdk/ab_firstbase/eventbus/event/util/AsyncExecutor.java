...
import com.xsdk.ab_firstbase.eventbus.event.EventBus;
...
public class AsyncExecutor {
    ...
    public void execute(final RunnableEx runnableEx) {
        this.threadPool.execute(new Runnable() { // from class: com.xsdk.ab_firstbase.eventbus.event.util.AsyncExecutor.1
