...
import com.xsdk.ab_firstbase.gson.internal.bind.ArrayTypeAdapter;
import com.xsdk.ab_firstbase.gson.internal.bind.CollectionTypeAdapterFactory;
import com.xsdk.ab_firstbase.gson.internal.bind.DateTypeAdapter;
import com.xsdk.ab_firstbase.gson.internal.bind.JsonAdapterAnnotationTypeAdapterFactory;
...
import com.xsdk.ab_firstbase.gson.internal.bind.MapTypeAdapterFactory;
import com.xsdk.ab_firstbase.gson.internal.bind.ObjectTypeAdapter;
import com.xsdk.ab_firstbase.gson.internal.bind.ReflectiveTypeAdapterFactory;
import com.xsdk.ab_firstbase.gson.internal.bind.SqlDateTypeAdapter;
import com.xsdk.ab_firstbase.gson.internal.bind.TimeTypeAdapter;
...
public final class Gson {
    ...
    public Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new JsonDeserializationContext() { // from class: com.xsdk.ab_firstbase.gson.Gson.1
            @Override // com.xsdk.ab_firstbase.gson.JsonDeserializationContext
            public <T> T deserialize(JsonElement jsonElement, Type type) throws JsonParseException {
                return (T) Gson.this.fromJson(jsonElement, type);
            }
        };
        this.serializationContext = new JsonSerializationContext() { // from class: com.xsdk.ab_firstbase.gson.Gson.2
            @Override // com.xsdk.ab_firstbase.gson.JsonSerializationContext
    ...
    private TypeAdapter<Number> doubleAdapter(boolean z) {
        ...
        return new TypeAdapter<Number>() { // from class: com.xsdk.ab_firstbase.gson.Gson.3
    ...
    private TypeAdapter<Number> floatAdapter(boolean z) {
        ...
        return new TypeAdapter<Number>() { // from class: com.xsdk.ab_firstbase.gson.Gson.4
            @Override // com.xsdk.ab_firstbase.gson.TypeAdapter
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
    ...
    private TypeAdapter<Number> longAdapter(LongSerializationPolicy longSerializationPolicy) {
        ...
        return new TypeAdapter<Number>() { // from class: com.xsdk.ab_firstbase.gson.Gson.5
