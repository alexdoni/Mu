...
public final class Response implements Closeable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = ShareConstants.WEB_DIALOG_PARAM_MESSAGE, imports = {}))
    ...
    public final boolean isRedirect() {
        ...
        if (i != 307 && i != 308) {
            switch (i) {
                case CallCode.HTTP_MULT_CHOICE /* 300 */:
                case 301:
                case 302:
                case 303:
                    break;
    ...
    public final CacheControl m3572deprecated_cacheControl() {
        return cacheControl();
    }
