...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final class Editor {
        ...
        public final Source newSource(int r5) {
            ...
            synchronized (diskLruCache) {
                ...
                try {
                    source = diskLruCache.getFileSystem().source(getEntry().getCleanFiles$okhttp().get(r5));
        ...
        public final Sink newSink(int r4) {
            ...
            synchronized (diskLruCache) {
                ...
                try {
                    return new FaultHidingSink(diskLruCache.getFileSystem().sink(getEntry().getDirtyFiles$okhttp().get(r4)), new Function1<IOException, Unit>() { // from class: okhttp3.internal.cache.DiskLruCache$Editor$newSink$1$1
                        /* JADX INFO: Access modifiers changed from: package-private */
    ...
    public final class Entry {
        ...
        private final Source newSource(int r3) {
            Source source = this.this$0.getFileSystem().source(this.cleanFiles.get(r3));
            if (this.this$0.civilizedFileSystem) {
                return source;
            }
