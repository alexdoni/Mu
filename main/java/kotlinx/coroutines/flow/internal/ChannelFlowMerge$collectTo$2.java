...
@Metadata(m1394d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m1395d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m1396k = 3, m1397mv = {1, 8, 0}, m1399xi = 48)
...
public final class ChannelFlowMerge$collectTo$2<T> implements FlowCollector {
    ...
    */
    ...
    @DebugMetadata(m1414c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m1415f = "Merge.kt", m1416i = {}, m1417l = {69}, m1418m = "invokeSuspend", m1419n = {}, m1420s = {})
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1 */
    /* loaded from: classes3.dex */
    public static final class C29991 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ SendingCollector<T> $collector;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C29991(Flow<? extends T> flow, SendingCollector<T> sendingCollector, Semaphore semaphore, Continuation<? super C29991> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C29991(this.$inner, this.$collector, this.$semaphore, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C29991) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
