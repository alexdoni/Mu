...
@DebugMetadata(m1414c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2", m1415f = "Delay.kt", m1416i = {0, 0, 0, 0}, m1417l = {CallCode.HTTP_ENTITY_TOO_LARGE}, m1418m = "invokeSuspend", m1419n = {"downstream", "values", "lastValue", "ticker"}, m1420s = {"L$0", "L$1", "L$2", "L$3"})
