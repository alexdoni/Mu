...
@DebugMetadata(m1414c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", m1415f = "Limit.kt", m1416i = {0}, m1417l = {CipherSuite.TLS_DH_RSA_WITH_SEED_CBC_SHA}, m1418m = "invokeSuspend", m1419n = {"collector$iv"}, m1420s = {"L$0"})
...
public final class FlowKt__LimitKt$transformWhile$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C2960xdf1aa1b6 c2960xdf1aa1b62 = new C2960xdf1aa1b6(this.$transform, flowCollector);
            try {
                this.L$0 = c2960xdf1aa1b62;
                this.label = 1;
                if (flow.collect(c2960xdf1aa1b62, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } catch (AbortFlowException e) {
                e = e;
                c2960xdf1aa1b6 = c2960xdf1aa1b62;
                FlowExceptions_commonKt.checkOwnership(e, c2960xdf1aa1b6);
            ...
            c2960xdf1aa1b6 = (C2960xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
