...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        do {
            ...
            return null;
        } while (!UByte$$ExternalSyntheticBackport0.m1412m(atomicReferenceFieldUpdater, this, task, (Object) null));
        return task;
    }
    ...
    private final Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if (task != null) {
            if ((task.taskContext.getTaskMode() == 1) == onlyBlocking && UByte$$ExternalSyntheticBackport0.m1411m(this.buffer, i, task, (Object) null)) {
                if (onlyBlocking) {
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<Task> stolenTaskRef) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m1412m(atomicReferenceFieldUpdater, this, (Object) r1, (Object) null));
