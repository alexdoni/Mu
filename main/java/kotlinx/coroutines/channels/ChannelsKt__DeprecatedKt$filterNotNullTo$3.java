...
@DebugMetadata(m1414c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m1415f = "Deprecated.kt", m1416i = {0, 0, 1, 1}, m1417l = {487, 242}, m1418m = "filterNotNullTo", m1419n = {"destination", "$this$consume$iv$iv", "destination", "$this$consume$iv$iv"}, m1420s = {"L$0", "L$1", "L$0", "L$1"})
