...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo3389receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo3389receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo3390tryReceivePtdJZtk() {
        return this._channel.mo3390tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo3385trySendJP2dKIU(E element) {
        return this._channel.mo3385trySendJP2dKIU(element);
    }
