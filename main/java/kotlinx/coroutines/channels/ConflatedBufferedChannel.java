...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m3413trySendImplMj0NB7M = conflatedBufferedChannel.m3413trySendImplMj0NB7M(e, true);
        if (m3413trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m3399exceptionOrNullimpl(m3413trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m3413trySendImplMj0NB7M = conflatedBufferedChannel.m3413trySendImplMj0NB7M(e, true);
        if (!(m3413trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo3385trySendJP2dKIU(E element) {
        return m3413trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m3413trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m3411trySendDropLatestMj0NB7M(element, isSendOp) : m3412trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m3411trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo3385trySendJP2dKIU = super.mo3385trySendJP2dKIU(element);
        if (ChannelResult.m3405isSuccessimpl(mo3385trySendJP2dKIU) || ChannelResult.m3403isClosedimpl(mo3385trySendJP2dKIU)) {
            return mo3385trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m3410successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m3412trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m3408closedJP2dKIU(getSendException());
                }
            } else {
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo3385trySendJP2dKIU = mo3385trySendJP2dKIU(element);
        if (!(mo3385trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo3385trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m3399exceptionOrNullimpl(mo3385trySendJP2dKIU);
