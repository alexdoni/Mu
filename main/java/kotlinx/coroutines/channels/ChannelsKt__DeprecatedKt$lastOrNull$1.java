...
@DebugMetadata(m1414c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m1415f = "Deprecated.kt", m1416i = {0, 0, 1, 1, 1}, m1417l = {123, 126}, m1418m = "lastOrNull", m1419n = {"$this$consume$iv", "iterator", "$this$consume$iv", "iterator", "last"}, m1420s = {"L$0", "L$1", "L$0", "L$1", "L$2"})
