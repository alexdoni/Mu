...
@DebugMetadata(m1414c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$takeWhile$1", m1415f = "Deprecated.kt", m1416i = {0, 1, 1, 2}, m1417l = {269, 270, 271}, m1418m = "invokeSuspend", m1419n = {"$this$produce", "$this$produce", "e", "$this$produce"}, m1420s = {"L$0", "L$0", "L$2", "L$0"})
