...
public interface SendChannel<E> {
    ...
    Object mo3385trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m3405isSuccessimpl(mo3385trySendJP2dKIU)) {
                return true;
            }
            Throwable m3399exceptionOrNullimpl = ChannelResult.m3399exceptionOrNullimpl(mo3385trySendJP2dKIU);
