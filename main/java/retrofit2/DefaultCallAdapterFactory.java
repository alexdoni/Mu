...
public final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        public void enqueue(Callback<T> callback) {
            ...
            this.delegate.enqueue(new C32211(callback));
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1 */
        /* loaded from: classes3.dex */
        public class C32211 implements Callback<T> {
            final /* synthetic */ Callback val$callback;

            C32211(Callback callback) {
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C32211.this.m1555xddacc936(callback, response);
                    }
                });
            }
            ...
            public /* synthetic */ void m1555xddacc936(Callback callback, Response response) {
            ...
            public /* synthetic */ void m1554x714e864(Callback callback, Throwable th) {
            ...
            public void onFailure(Call<T> call, final Throwable th) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C32211.this.m1554x714e864(callback, th);
                    }
                });
            }
        }
