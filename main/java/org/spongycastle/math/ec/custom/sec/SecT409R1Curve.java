...
public class SecT409R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT409R1Curve() {
        super(CallCode.HTTP_CONFLICT, 87, 0, 0);
        this.infinity = new SecT409R1Point(this, null, null);
        this.f2612a = fromBigInteger(BigInteger.valueOf(1L));
        this.f2613b = fromBigInteger(new BigInteger(1, Hex.decode("0021A5C2C8EE9FEB5C4B9A753B7B476B7FD6422EF1F3DD674761FA99D6AC27C8A9A197B272822F6CD57A55AA4F50AE317B13545F")));
