...
public class SecT233K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (multiply.isZero()) {
            return new SecT233K1Point(curve, multiply, curve.getB(), this.withCompression);
        }
        ...
        return new SecT233K1Point(curve, square2, square3.add(multiply).add(square).multiply(square3).add(eCFieldElement3).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }
