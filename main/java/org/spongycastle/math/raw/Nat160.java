...
public abstract class Nat160 {
    ...
    /* renamed from: M */
    private static final long f2718M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m1545eq(int[] iArr, int[] iArr2) {
        for (int i = 4; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 5) {
            ...
            iArr3[i + 4] = (int) j15;
            long j16 = (j15 >>> 32) + j7 + (iArr3[r0] & 4294967295L);
            iArr3[i + 5] = (int) j16;
            j7 = j16 >>> 32;
            i = i2;
            j = 4294967295L;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i4 < 5) {
            ...
            iArr3[i5 + 4] = (int) j15;
            long j16 = (j15 >>> 32) + j7 + (iArr3[r12] & 4294967295L);
            iArr3[i5 + 5] = (int) j16;
            j7 = j16 >>> 32;
            i4++;
            i5 = i6;
