...
public abstract class Nat128 {
    ...
    /* renamed from: M */
    private static final long f2717M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m1544eq(int[] iArr, int[] iArr2) {
        for (int i = 3; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 4) {
            ...
            iArr3[i + 3] = (int) j11;
            long j12 = (j11 >>> 32) + j6 + (iArr3[r0] & 4294967295L);
            iArr3[i + 4] = (int) j12;
            j6 = j12 >>> 32;
            i = i2;
            j = 4294967295L;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i4 < 4) {
            ...
            iArr3[i5 + 3] = (int) j12;
            long j13 = (j12 >>> 32) + j6 + (iArr3[r10] & 4294967295L);
            iArr3[i5 + 4] = (int) j13;
            j6 = j13 >>> 32;
            i4++;
            i5 = i6;
