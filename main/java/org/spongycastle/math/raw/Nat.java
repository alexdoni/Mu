...
public abstract class Nat {
    ...
    /* renamed from: M */
    private static final long f2716M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m1543eq(int i, int[] iArr, int[] iArr2) {
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long mulWordAddTo = (mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2) & 4294967295L) + j + (4294967295L & iArr3[r6]);
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            long mulWordAddTo = (mulWordAddTo(i, iArr[i2 + i6], iArr2, i3, iArr3, i5) & 4294967295L) + j + (4294967295L & iArr3[r4]);
