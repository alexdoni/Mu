...
public abstract class Nat192 {
    ...
    /* renamed from: M */
    private static final long f2719M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m1546eq(int[] iArr, int[] iArr2) {
        for (int i = 5; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 6) {
            ...
            iArr3[i + 5] = (int) j17;
            long j18 = (j17 >>> 32) + j8 + (iArr3[r0] & 4294967295L);
            iArr3[i + 6] = (int) j18;
            j8 = j18 >>> 32;
            i = i2;
            j = 4294967295L;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i4 < 6) {
            ...
            iArr3[i5 + 5] = (int) j16;
            long j17 = (j16 >>> 32) + j7 + (iArr3[r14] & 4294967295L);
            iArr3[i5 + 6] = (int) j17;
            j7 = j17 >>> 32;
            i4++;
            j6 = j9;
