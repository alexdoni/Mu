...
public class ASN1OutputStream {
    ...
    /* renamed from: os */
    private OutputStream f1989os;

    public ASN1OutputStream(OutputStream outputStream) {
        this.f1989os = outputStream;
    }
    ...
    public void write(int i) throws IOException {
        this.f1989os.write(i);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void write(byte[] bArr) throws IOException {
        this.f1989os.write(bArr);
    }

    void write(byte[] bArr, int i, int i2) throws IOException {
        this.f1989os.write(bArr, i, i2);
    }
    ...
    public void writeNull() throws IOException {
        this.f1989os.write(5);
        this.f1989os.write(0);
    }
    ...
    public void writeImplicitObject(ASN1Primitive aSN1Primitive) throws IOException {
        if (aSN1Primitive != null) {
            aSN1Primitive.encode(new ImplicitOutputStream(this.f1989os));
            return;
        }
        throw new IOException("null object detected");
    }
    ...
    public ASN1OutputStream getDERSubStream() {
        return new DEROutputStream(this.f1989os);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public ASN1OutputStream getDLSubStream() {
        return new DLOutputStream(this.f1989os);
    }
