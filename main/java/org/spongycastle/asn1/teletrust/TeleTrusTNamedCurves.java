...
public class TeleTrusTNamedCurves {
    static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.1
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16), new BigInteger("340E7BE2A280EB74E2BE61BADA745D97E8F7C300", 16), new BigInteger("1E589A8595423412134FAA2DBDEC95C8D8675E58", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("04BED5AF16EA3F6A4F62938C4631EB5AF7BDBCDBC31667CB477A1A8EC338F94741669C976316DA6321")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP160t1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.2
        ...
        protected X9ECParameters createParameters() {
            BigInteger bigInteger = new BigInteger("E95E4A5F737059DC60DF5991D45029409E60FC09", 16);
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16), new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620C", 16), new BigInteger("7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("04B199B13B9B34EFC1397E64BAEB05ACC265FF2378ADD6718B7C7C1961F0991B842443772152C9E0AD")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP192r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.3
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16), new BigInteger("6A91174076B1E0E19C39C031FE8685C1CAE040E5C69A28EF", 16), new BigInteger("469A28EF7C28CCA3DC721D044F4496BCCA7EF4146FBF25C9", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("04C0A0647EAAB6A48753B033C56CB0F0900A2F5C4853375FD614B690866ABD5BB88B5F4828C1490002E6773FA2FA299B8F")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP192t1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.4
        ...
        protected X9ECParameters createParameters() {
            BigInteger bigInteger = new BigInteger("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1", 16);
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16), new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86294", 16), new BigInteger("13D56FFAEC78681E68F9DEB43B35BEC2FB68542E27897B79", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("043AE9E58C82F63C30282E1FE7BBF43FA72C446AF6F4618129097E2C5667C2223A902AB5CA449D0084B7E5B3DE7CCC01C9")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP224r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.5
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF", 16), new BigInteger("68A5E62CA9CE6C1C299803A6C1530B514E182AD8B0042A59CAD29F43", 16), new BigInteger("2580F63CCFE44138870713B1A92369E33E2135D266DBB372386C400B", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("040D9029AD2C7E5CF4340823B2A87DC68C9E4CE3174C1E6EFDEE12C07D58AA56F772C0726F24C6B89E4ECDAC24354B9E99CAA3F6D3761402CD")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP224t1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.6
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("046AB1E344CE25FF3896424E7FFE14762ECB49F8928AC0C76029B4D5800374E9F5143E568CD23F3F4D7C0D4B1E41C8CC0D1C6ABD5F1A46DB4C")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP256r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.7
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377", 16), new BigInteger("7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9", 16), new BigInteger("26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("048BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP256t1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.8
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("04A3E8EB3CC1CFE7B7732213B23A656149AFA142C47AAFBC2B79A191562E1305F42D996C823439C56D7F7B22E14644417E69BCB6DE39D027001DABE8F35B25C9BE")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP320r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.9
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("D35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E27", 16), new BigInteger("3EE30B568FBAB0F883CCEBD46D3F3BB8A2A73513F5EB79DA66190EB085FFA9F492F375A97D860EB4", 16), new BigInteger("520883949DFDBC42D3AD198640688A6FE13F41349554B49ACC31DCCD884539816F5EB4AC8FB1F1A6", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("0443BD7E9AFB53D8B85289BCC48EE5BFE6F20137D10A087EB6E7871E2A10A599C710AF8D0D39E2061114FDD05545EC1CC8AB4093247F77275E0743FFED117182EAA9C77877AAAC6AC7D35245D1692E8EE1")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP320t1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.10
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("04925BE9FB01AFC6FB4D3E7D4990010F813408AB106C4F09CB7EE07868CC136FFF3357F624A21BED5263BA3A7A27483EBF6671DBEF7ABB30EBEE084E58A0B077AD42A5A0989D1EE71B1B9BC0455FB0D2C3")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP384r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.11
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53", 16), new BigInteger("7BC382C63D8C150C3C72080ACE05AFA0C2BEA28E4FB22787139165EFBA91F90F8AA5814A503AD4EB04A8C7DD22CE2826", 16), new BigInteger("4A8C7DD22CE28268B39B55416F0447C2FB77DE107DCD2A62E880EA53EEB62D57CB4390295DBC9943AB78696FA504C11", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("041D1C64F068CF45FFA2A63A81B7C13F6B8847A3E77EF14FE3DB7FCAFE0CBD10E8E826E03436D646AAEF87B2E247D4AF1E8ABE1D7520F9C2A45CB1EB8E95CFD55262B70B29FEEC5864E19C054FF99129280E4646217791811142820341263C5315")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP384t1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.12
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("0418DE98B02DB9A306F2AFCD7235F72A819B80AB12EBD653172476FECD462AABFFC4FF191B946A5F54D8D0AA2F418808CC25AB056962D30651A114AFD2755AD336747F93475B7A1FCA3B88F2B6A208CCFE469408584DC2B2912675BF5B9E582928")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP512r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.13
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve configureCurve = TeleTrusTNamedCurves.configureCurve(new ECCurve.C3197Fp(new BigInteger("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA703308717D4D9B009BC66842AECDA12AE6A380E62881FF2F2D82C68528AA6056583A48F3", 16), new BigInteger("7830A3318B603B89E2327145AC234CC594CBDD8D3DF91610A83441CAEA9863BC2DED5D5AA8253AA10A2EF1C98B9AC8B57F1117A72BF2C7B9E7C1AC4D77FC94CA", 16), new BigInteger("3DF91610A83441CAEA9863BC2DED5D5AA8253AA10A2EF1C98B9AC8B57F1117A72BF2C7B9E7C1AC4D77FC94CADC083E67984050B75EBAE5DD2809BD638016F723", 16), bigInteger, bigInteger2));
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("")), bigInteger, bigInteger2);
        }
    };
    static X9ECParametersHolder brainpoolP512t1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.teletrust.TeleTrusTNamedCurves.14
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("")), bigInteger, bigInteger2);
        }
    };
