...
public class KeyPurposeId extends ASN1Object {
    ...
    /* renamed from: id */
    private ASN1ObjectIdentifier f2058id;
    ...
    static {
        ...
        id_kp_timeStamping = new KeyPurposeId(aSN1ObjectIdentifier.branch(Constants.SDK_LOGIN_TYPE_HUAWEI));
    ...
    private KeyPurposeId(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        this.f2058id = aSN1ObjectIdentifier;
    }
    ...
    public String getId() {
        return this.f2058id.getId();
    }

    public String toString() {
        return this.f2058id.toString();
    }
}
