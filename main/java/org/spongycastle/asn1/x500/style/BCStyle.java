...
public class BCStyle extends AbstractX500NameStyle {
    ...
    /* renamed from: C */
    public static final ASN1ObjectIdentifier f2035C;

    /* renamed from: CN */
    public static final ASN1ObjectIdentifier f2036CN;
    public static final ASN1ObjectIdentifier COUNTRY_OF_CITIZENSHIP;
    public static final ASN1ObjectIdentifier COUNTRY_OF_RESIDENCE;
    public static final ASN1ObjectIdentifier DATE_OF_BIRTH;

    /* renamed from: DC */
    public static final ASN1ObjectIdentifier f2037DC;
    ...
    /* renamed from: E */
    public static final ASN1ObjectIdentifier f2038E;
    ...
    /* renamed from: L */
    public static final ASN1ObjectIdentifier f2039L;
    public static final ASN1ObjectIdentifier NAME;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH;

    /* renamed from: O */
    public static final ASN1ObjectIdentifier f2040O;
    public static final ASN1ObjectIdentifier ORGANIZATION_IDENTIFIER;

    /* renamed from: OU */
    public static final ASN1ObjectIdentifier f2041OU;
    ...
    /* renamed from: SN */
    public static final ASN1ObjectIdentifier f2042SN;

    /* renamed from: ST */
    public static final ASN1ObjectIdentifier f2043ST;
    public static final ASN1ObjectIdentifier STREET;
    public static final ASN1ObjectIdentifier SURNAME;

    /* renamed from: T */
    public static final ASN1ObjectIdentifier f2044T;
    ...
    static {
        ...
        hashtable2.put(UserDataStore.STATE, intern9);
        hashtable2.put("sn", intern6);
        hashtable2.put("serialnumber", intern6);
        hashtable2.put("street", intern7);
    ...
    protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        if (aSN1ObjectIdentifier.equals(EmailAddress) || aSN1ObjectIdentifier.equals(f2037DC)) {
            return new DERIA5String(str);
        }
        if (aSN1ObjectIdentifier.equals(DATE_OF_BIRTH)) {
            return new ASN1GeneralizedTime(str);
        }
        if (aSN1ObjectIdentifier.equals(f2035C) || aSN1ObjectIdentifier.equals(f2042SN) || aSN1ObjectIdentifier.equals(DN_QUALIFIER) || aSN1ObjectIdentifier.equals(TELEPHONE_NUMBER)) {
