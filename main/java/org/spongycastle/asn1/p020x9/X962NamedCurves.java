...
public class X962NamedCurves {
    static X9ECParametersHolder prime192v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.1
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve.C3197Fp c3197Fp = new ECCurve.C3197Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("64210519e59c80e70fa7e9ab72243049feb8deecc146b9b1", 16), bigInteger, valueOf);
            return new X9ECParameters(c3197Fp, new X9ECPoint(c3197Fp, Hex.decode("03188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012")), bigInteger, valueOf, Hex.decode("3045AE6FC8422f64ED579528D38120EAE12196D5"));
        }
    };
    static X9ECParametersHolder prime192v2 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.2
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C3197Fp c3197Fp = new ECCurve.C3197Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("cc22d6dfb95c6b25e49c0d6364a4e5980c393aa21668d953", 16), bigInteger, valueOf);
            return new X9ECParameters(c3197Fp, new X9ECPoint(c3197Fp, Hex.decode("03eea2bae7e1497842f2de7769cfe9c989c072ad696f48034a")), bigInteger, valueOf, Hex.decode("31a92ee2029fd10d901b113e990710f0d21ac6b6"));
        }
    };
    static X9ECParametersHolder prime192v3 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.3
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C3197Fp c3197Fp = new ECCurve.C3197Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("22123dc2395a05caa7423daeccc94760a7d462256bd56916", 16), bigInteger, valueOf);
            return new X9ECParameters(c3197Fp, new X9ECPoint(c3197Fp, Hex.decode("027d29778100c65a1da1783716588dce2b8b4aee8e228f1896")), bigInteger, valueOf, Hex.decode("c469684435deb378c4b65ca9591e2a5763059a2e"));
        }
    };
    static X9ECParametersHolder prime239v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.4
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C3197Fp c3197Fp = new ECCurve.C3197Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("6b016c3bdcf18941d0d654921475ca71a9db2fb27d1d37796185c2942c0a", 16), bigInteger, valueOf);
            return new X9ECParameters(c3197Fp, new X9ECPoint(c3197Fp, Hex.decode("020ffa963cdca8816ccc33b8642bedf905c3d358573d3f27fbbd3b3cb9aaaf")), bigInteger, valueOf, Hex.decode("e43bb460f0b80cc0c0b075798e948060f8321b7d"));
        }
    };
    static X9ECParametersHolder prime239v2 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.5
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C3197Fp c3197Fp = new ECCurve.C3197Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("617fab6832576cbbfed50d99f0249c3fee58b94ba0038c7ae84c8c832f2c", 16), bigInteger, valueOf);
            return new X9ECParameters(c3197Fp, new X9ECPoint(c3197Fp, Hex.decode("0238af09d98727705120c921bb5e9e26296a3cdcf2f35757a0eafd87b830e7")), bigInteger, valueOf, Hex.decode("e8b4011604095303ca3b8099982be09fcb9ae616"));
        }
    };
    static X9ECParametersHolder prime239v3 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.6
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C3197Fp c3197Fp = new ECCurve.C3197Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("255705fa2a306654b1f4cb03d6a750a30c250102d4988717d9ba15ab6d3e", 16), bigInteger, valueOf);
            return new X9ECParameters(c3197Fp, new X9ECPoint(c3197Fp, Hex.decode("036768ae8e18bb92cfcf005c949aa2c6d94853d0e660bbf854b1c9505fe95a")), bigInteger, valueOf, Hex.decode("7d7374168ffe3471b60a857686a19475d3bfa2ff"));
        }
    };
    static X9ECParametersHolder prime256v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.7
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1L);
            ECCurve.C3197Fp c3197Fp = new ECCurve.C3197Fp(new BigInteger("115792089210356248762697446949407573530086143415290314195533631308867097853951"), new BigInteger("ffffffff00000001000000000000000000000000fffffffffffffffffffffffc", 16), new BigInteger("5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", 16), bigInteger, valueOf);
            return new X9ECParameters(c3197Fp, new X9ECPoint(c3197Fp, Hex.decode("036b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296")), bigInteger, valueOf, Hex.decode("c49d360886e704936a6678e1139d26b7819f7e90"));
        }
    };
    static X9ECParametersHolder c2pnb163v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.8
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m(CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 1, 2, 8, new BigInteger("072546B5435234A422E0789675F432C89435DE5242", 16), new BigInteger("00C9517D06D5240D3CFF38C74B20B6CD4D6F9DD4D9", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2pnb163v2 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.9
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2L);
            ECCurve.F2m f2m = new ECCurve.F2m(CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 1, 2, 8, new BigInteger("0108B39E77C4B108BED981ED0E890E117C511CF072", 16), new BigInteger("0667ACEB38AF4E488C407433FFAE4F1C811638DF20", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2pnb163v3 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.10
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2L);
            ECCurve.F2m f2m = new ECCurve.F2m(CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 1, 2, 8, new BigInteger("07A526C63D3E25A256A007699F5447E32AE456B50E", 16), new BigInteger("03F7061798EB99E238FD6F1BF95B48FEEB4854252B", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2pnb176w1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.11
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m(CipherSuite.TLS_PSK_WITH_NULL_SHA256, 1, 2, 43, new BigInteger("00E4E6DB2995065C407D9D39B8D0967B96704BA8E9C90B", 16), new BigInteger("005DDA470ABE6414DE8EC133AE28E9BBD7FCEC0AE0FFF2", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2tnb191v1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.12
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2L);
            ECCurve.F2m f2m = new ECCurve.F2m(CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256, 9, new BigInteger("2866537B676752636A68F56554E12640276B649EF7526267", 16), new BigInteger("2E45EF571F00786F67B0081B9495A3D95462F5DE0AA185EC", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2tnb191v2 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.13
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m(CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256, 9, new BigInteger("401028774D7777C7B7666D1366EA432071274F89FF01E718", 16), new BigInteger("0620048D28BCBD03B6249C99182B7C8CD19700C362C46A01", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2tnb191v3 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.14
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m(CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256, 9, new BigInteger("6C01074756099122221056911C77D77E77A777E7E7E77FCB", 16), new BigInteger("71FE1AF926CF847989EFEF8DB459F66394D90F32AD3F15E8", 16), bigInteger, valueOf);
