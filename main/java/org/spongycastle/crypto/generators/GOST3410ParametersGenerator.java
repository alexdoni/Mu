        ...
        while (i13 < i10) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    i5 = i14;
                    if (add2.compareTo(bigInteger10.pow(iArr[i12])) == 1) {
                        break;
                    }
                    if (bigInteger10.modPow(bigIntegerArr4[i18].multiply(add.add(BigInteger.valueOf(j))), bigIntegerArr4[i12]).compareTo(bigInteger9) == 0 && bigInteger10.modPow(add.add(BigInteger.valueOf(j)), bigIntegerArr4[i12]).compareTo(bigInteger9) != 0) {
                        break;
                    }
                    i19 += 2;
                    i10 = i4;
