...
public class DSAParametersGenerator {
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f2373L = i;
        this.f2374N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f2373L), (i2 + 1) / 2);
        ...
        while (true) {
            ...
            if (isProbablePrime(bigInteger)) {
                ...
                while (i6 < 4096) {
                    ...
                    if (subtract.bitLength() == this.f2373L && isProbablePrime(subtract)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f2374N / 8];
        int i2 = this.f2373L;
        ...
        loop0: while (true) {
            ...
            bit = new BigInteger(1, bArr3).mod(ONE.shiftLeft(this.f2374N - 1)).setBit(0).setBit(this.f2374N - 1);
            if (isProbablePrime(bit)) {
                byte[] clone = Arrays.clone(bArr);
                int i7 = this.f2373L * 4;
                i = 0;
                while (i < i7) {
