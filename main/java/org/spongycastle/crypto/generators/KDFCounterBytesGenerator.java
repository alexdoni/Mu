...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f2375h));
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f2376k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f2375h, i8);
            System.arraycopy(this.f2376k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    private void generateNext() {
        int i = (this.generatedBytes / this.f2375h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f2376k, 0);
    }
}
