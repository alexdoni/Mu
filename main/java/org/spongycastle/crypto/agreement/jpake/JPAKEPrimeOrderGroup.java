...
public class JPAKEPrimeOrderGroup {
    ...
    /* renamed from: g */
    private final BigInteger f2093g;

    /* renamed from: p */
    private final BigInteger f2094p;

    /* renamed from: q */
    private final BigInteger f2095q;
    ...
    public JPAKEPrimeOrderGroup(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, boolean z) {
        ...
        this.f2094p = bigInteger;
        this.f2095q = bigInteger2;
        this.f2093g = bigInteger3;
    }
