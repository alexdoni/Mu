...
public class OpenPGPCFBBlockCipher implements BlockCipher {
    ...
    /* renamed from: FR */
    private byte[] f2444FR;
    private byte[] FRE;

    /* renamed from: IV */
    private byte[] f2445IV;
    ...
    public OpenPGPCFBBlockCipher(BlockCipher blockCipher) {
        ...
        this.f2445IV = new byte[blockSize];
        this.f2444FR = new byte[blockSize];
    ...
    public void reset() {
        this.count = 0;
        byte[] bArr = this.f2445IV;
        byte[] bArr2 = this.f2444FR;
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        ...
        if (i6 > i5) {
            ...
            byte[] bArr7 = this.f2444FR;
            System.arraycopy(bArr7, 2, bArr7, 0, this.blockSize - 2);
            System.arraycopy(bArr2, i2, this.f2444FR, this.blockSize - 2, 2);
            this.cipher.processBlock(this.f2444FR, 0, this.FRE, 0);
            while (true) {
                i3 = this.blockSize;
                if (i7 >= i3) {
