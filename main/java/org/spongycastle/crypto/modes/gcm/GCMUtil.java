...
public abstract class GCMUtil {
    ...
    /* renamed from: E1 */
    private static final int f2451E1 = -520093696;
    ...
    public static void multiplyP(int[] iArr) {
        int shiftRight = shiftRight(iArr) >> 8;
        iArr[0] = (shiftRight & f2451E1) ^ iArr[0];
    }

    public static void multiplyP(int[] iArr, int[] iArr2) {
        int shiftRight = shiftRight(iArr, iArr2) >> 8;
        iArr2[0] = (shiftRight & f2451E1) ^ iArr2[0];
    }
