...
public class KCTRBlockCipher extends StreamBlockCipher {
    ...
    public KCTRBlockCipher(BlockCipher blockCipher) {
        ...
        this.f2438iv = new byte[blockCipher.getBlockSize()];
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            byte[] bArr = this.f2438iv;
            int length = bArr.length - iv.length;
            Arrays.fill(bArr, (byte) 0);
            System.arraycopy(iv, 0, this.f2438iv, length, iv.length);
    ...
    public void reset() {
        if (this.initialised) {
            this.engine.processBlock(this.f2438iv, 0, this.ofbV, 0);
        }
        this.engine.reset();
        this.byteCount = 0;
    }
