...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (keyParameter != null) {
            ...
            this.multiplier.init(this.f2428H);
            this.exp = null;
        } else if (this.f2428H == null) {
        ...
        if (bArr5.length == 12) {
            ...
            gHASHBlock(this.f2429J0, bArr6);
        }
        this.f2430S = new byte[16];
        ...
        this.atLength = 0L;
        this.atLengthPre = 0L;
        this.counter = Arrays.clone(this.f2429J0);
    ...
    private void initCipher() {
        ...
        if (this.atLengthPre > 0) {
            System.arraycopy(this.S_atPre, 0, this.f2430S, 0, 16);
        }
    }
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException {
        ...
        if (j2 > this.atLengthPre) {
            ...
            if (this.exp == null) {
                ...
                tables1kGCMExponentiator.init(this.f2428H);
            }
            this.exp.exponentiateX(j3, bArr2);
            GCMUtil.multiply(this.S_at, bArr2);
            GCMUtil.xor(this.f2430S, this.S_at);
        }
        byte[] bArr3 = new byte[16];
        Pack.longToBigEndian(this.atLength * 8, bArr3, 0);
        Pack.longToBigEndian(this.totalLength * 8, bArr3, 8);
        gHASHBlock(this.f2430S, bArr3);
        byte[] bArr4 = new byte[16];
        this.cipher.processBlock(this.f2429J0, 0, bArr4, 0);
        GCMUtil.xor(bArr4, this.f2430S);
        int i5 = this.macSize;
