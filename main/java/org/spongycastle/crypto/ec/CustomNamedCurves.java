...
public class CustomNamedCurves {
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.3
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurveGLV, new X9ECPoint(configureCurveGLV, Hex.decode("043B4C382CE37AA192A4019E763036F4F5DD4D7EBB938CF935318FDCED6BC28286531733C3F03C4FEE")), configureCurveGLV.getOrder(), configureCurveGLV.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.6
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurveGLV, new X9ECPoint(configureCurveGLV, Hex.decode("04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D")), configureCurveGLV.getOrder(), configureCurveGLV.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.8
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurveGLV, new X9ECPoint(configureCurveGLV, Hex.decode("04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5")), configureCurveGLV.getOrder(), configureCurveGLV.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.10
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurveGLV, new X9ECPoint(configureCurveGLV, Hex.decode("0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8")), configureCurveGLV.getOrder(), configureCurveGLV.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.18
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9")), configureCurve.getOrder(), configureCurve.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.23
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3")), configureCurve.getOrder(), configureCurve.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.25
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA")), configureCurve.getOrder(), configureCurve.getCofactor(), (byte[]) null);
        }
    };
    static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.26
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("040503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC245849283601CCDA380F1C9E318D90F95D07E5426FE87E45C0E8184698E45962364E34116177DD2259")), configureCurve.getOrder(), configureCurve.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder sm2p256v1 = new X9ECParametersHolder() { // from class: org.spongycastle.crypto.ec.CustomNamedCurves.32
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(configureCurve, new X9ECPoint(configureCurve, Hex.decode("0432C4AE2C1F1981195F9904466A39C9948FE30BBFF2660BE1715A4589334C74C7BC3736A2F4F6779C59BDCEE36B692153D0A9877CC62A474002DF32E52139F0A0")), configureCurve.getOrder(), configureCurve.getCofactor(), (byte[]) null);
        }
    };
