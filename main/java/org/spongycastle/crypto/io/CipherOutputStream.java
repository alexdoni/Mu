    ...
    */
    public void close() throws java.io.IOException {
        /*
            ...
            org.spongycastle.crypto.BufferedBlockCipher r0 = r4.bufferedBlockCipher     // Catch: java.lang.Exception -> L36 org.spongycastle.crypto.InvalidCipherTextException -> L3f
            if (r0 == 0) goto L19
            byte[] r2 = r4.buf     // Catch: java.lang.Exception -> L36 org.spongycastle.crypto.InvalidCipherTextException -> L3f
            int r0 = r0.doFinal(r2, r1)     // Catch: java.lang.Exception -> L36 org.spongycastle.crypto.InvalidCipherTextException -> L3f
            if (r0 == 0) goto L34
            ...
            r2.write(r3, r1, r0)     // Catch: java.lang.Exception -> L36 org.spongycastle.crypto.InvalidCipherTextException -> L3f
            goto L34
        L19:
            org.spongycastle.crypto.modes.AEADBlockCipher r0 = r4.aeadBlockCipher     // Catch: java.lang.Exception -> L36 org.spongycastle.crypto.InvalidCipherTextException -> L3f
            if (r0 == 0) goto L2d
            byte[] r2 = r4.buf     // Catch: java.lang.Exception -> L36 org.spongycastle.crypto.InvalidCipherTextException -> L3f
            int r0 = r0.doFinal(r2, r1)     // Catch: java.lang.Exception -> L36 org.spongycastle.crypto.InvalidCipherTextException -> L3f
            if (r0 == 0) goto L34
