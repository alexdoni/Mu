...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    /* renamed from: _P */
    private ECPoint f2531_P;

    /* renamed from: _Q */
    private ECPoint f2532_Q;
    private ECCurve.C3197Fp _curve;
    ...
    static {
        ...
        nistPoints = r2;
        ECCurve.C3197Fp c3197Fp = (ECCurve.C3197Fp) NISTNamedCurves.getByName("P-256").getCurve();
        ECCurve.C3197Fp c3197Fp2 = (ECCurve.C3197Fp) NISTNamedCurves.getByName("P-384").getCurve();
        ECCurve.C3197Fp c3197Fp3 = (ECCurve.C3197Fp) NISTNamedCurves.getByName("P-521").getCurve();
        DualECPoints[] dualECPointsArr = {new DualECPoints(128, c3197Fp.createPoint(bigInteger, bigInteger2), c3197Fp.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(192, c3197Fp2.createPoint(bigInteger5, bigInteger6), c3197Fp2.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, c3197Fp3.createPoint(bigInteger9, bigInteger10), c3197Fp3.createPoint(bigInteger11, bigInteger12), 1)};
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0076, code lost:
        ...
        if (r1.f2531_P == null) goto L23;
     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0078, code lost:
    
        r2 = org.spongycastle.crypto.prng.drbg.Utils.hash_df(r1._digest, r5, r1._seedlen);
        r1.f2533_s = r2;
    ...
    */
    public DualECSP800DRBG(org.spongycastle.crypto.prng.drbg.DualECPoints[] r2, org.spongycastle.crypto.Digest r3, int r4, org.spongycastle.crypto.prng.EntropySource r5, byte[] r6, byte[] r7) {
        /*
            r1 = this;
            r1.<init>()
            ...
            boolean r0 = org.spongycastle.crypto.prng.drbg.Utils.isTooLarge(r6, r0)
            if (r0 != 0) goto Lab
            ...
            byte[] r5 = org.spongycastle.util.Arrays.concatenate(r5, r7, r6)
            r6 = 0
        L2f:
            int r7 = r2.length
            if (r6 == r7) goto L74
            ...
            if (r4 > r7) goto L71
            int r3 = org.spongycastle.crypto.prng.drbg.Utils.getMaxSecurityStrength(r3)
            r4 = r2[r6]
            ...
            r1._outlen = r3
            r3 = r2[r6]
            org.spongycastle.math.ec.ECPoint r3 = r3.getP()
            r1.f2531_P = r3
            r2 = r2[r6]
        ...
        L71:
            ...
            goto L2f
        L74:
            org.spongycastle.math.ec.ECPoint r2 = r1.f2531_P
            if (r2 == 0) goto L8a
            org.spongycastle.crypto.Digest r2 = r1._digest
            int r3 = r1._seedlen
            byte[] r2 = org.spongycastle.crypto.prng.drbg.Utils.hash_df(r2, r5, r3)
            r1.f2533_s = r2
            int r2 = r2.length
            r1._sLength = r2
            r2 = 0
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        if (bArr2 != null) {
            bigInteger = new BigInteger(1, xor(this.f2533_s, Utils.hash_df(this._digest, bArr2, this._seedlen)));
        } else {
            bigInteger = new BigInteger(1, this.f2533_s);
        }
        Arrays.fill(bArr, (byte) 0);
        int i = 0;
        for (int i2 = 0; i2 < length2; i2++) {
            bigInteger = getScalarMultipleXCoord(this.f2531_P, bigInteger);
            byte[] byteArray = getScalarMultipleXCoord(this.f2532_Q, bigInteger).toByteArray();
        ...
        if (i < bArr.length) {
            bigInteger = getScalarMultipleXCoord(this.f2531_P, bigInteger);
            byte[] byteArray2 = getScalarMultipleXCoord(this.f2532_Q, bigInteger).toByteArray();
        ...
        this.f2533_s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this.f2531_P, bigInteger));
        return length;
    }
    ...
    public void reseed(byte[] bArr) {
        ...
        this.f2533_s = Utils.hash_df(this._digest, Arrays.concatenate(pad8(this.f2533_s, this._seedlen), getEntropy(), bArr), this._seedlen);
