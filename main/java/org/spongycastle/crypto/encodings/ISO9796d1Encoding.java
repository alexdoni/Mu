...
public class ISO9796d1Encoding implements AsymmetricBlockCipher {
    ...
    private static byte[] shadows = {Ascii.f556SO, 3, 5, 8, 9, 4, 2, Ascii.f555SI, 0, Ascii.f546CR, 11, 6, 7, 10, Ascii.f548FF, 1};
    private static byte[] inverse = {8, Ascii.f555SI, 6, 1, 5, 2, 11, Ascii.f548FF, 3, 4, Ascii.f546CR, 10, Ascii.f556SO, 9, 0, 7};
    ...
    private byte[] encodeBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        for (int i10 = i4 - (i7 * 2); i10 != i4; i10 += 2) {
            ...
            byte[] bArr3 = shadows;
            bArr2[i10] = (byte) (bArr3[b & Ascii.f555SI] | (bArr3[(b & 255) >>> 4] << 4));
            bArr2[i10 + 1] = b;
        }
        int i11 = i4 - (i2 * 2);
    ...
    private byte[] decodeBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if ((convertOutputDecryptOnly[convertOutputDecryptOnly.length - 1] & Ascii.f555SI) != 6) {
        ...
        byte b2 = (byte) (bArr2[b & Ascii.f555SI] | (bArr2[(b & 255) >>> 4] << 4));
        ...
        for (int length = convertOutputDecryptOnly.length - 1; length >= convertOutputDecryptOnly.length - (i3 * 2); length -= 2) {
            ...
            int i6 = bArr3[b3 & Ascii.f555SI] | (bArr3[(b3 & 255) >>> 4] << 4);
            int i7 = length - 1;
