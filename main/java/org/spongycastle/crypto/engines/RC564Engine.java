...
public class RC564Engine implements BlockCipher {
    ...
    private void setKey(byte[] bArr) {
        ...
        for (int i6 = 0; i6 < length2; i6++) {
            long[] jArr4 = this.f2334_S;
            j = rotateLeft(jArr4[i4] + j + j2, 3L);
            jArr4[i4] = j;
            j2 = rotateLeft(jArr2[i5] + j + j2, j2 + j);
            jArr2[i5] = j2;
            i4 = (i4 + 1) % this.f2334_S.length;
            i5 = (i5 + 1) % length;
        }
    }

    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        long bytesToWord = bytesToWord(bArr, i) + this.f2334_S[0];
        long bytesToWord2 = bytesToWord(bArr, i + 8) + this.f2334_S[1];
        for (int i3 = 1; i3 <= this._noRounds; i3++) {
            int i4 = i3 * 2;
            bytesToWord = rotateLeft(bytesToWord ^ bytesToWord2, bytesToWord2) + this.f2334_S[i4];
            bytesToWord2 = rotateLeft(bytesToWord2 ^ bytesToWord, bytesToWord) + this.f2334_S[i4 + 1];
        }
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = this._noRounds; i3 >= 1; i3--) {
            int i4 = i3 * 2;
            bytesToWord2 = rotateRight(bytesToWord2 - this.f2334_S[i4 + 1], bytesToWord) ^ bytesToWord;
            bytesToWord = rotateRight(bytesToWord - this.f2334_S[i4], bytesToWord2) ^ bytesToWord2;
        }
        wordToBytes(bytesToWord - this.f2334_S[0], bArr2, i2);
        wordToBytes(bytesToWord2 - this.f2334_S[1], bArr2, i2 + 8);
        return 16;
    }
