...
public class ThreefishEngine implements BlockCipher {
    ...
    private void setKey(long[] jArr) {
        ...
        while (true) {
            ...
            if (i < i2) {
                long[] jArr2 = this.f2359kw;
                long j2 = jArr[i];
                jArr2[i] = j2;
                j ^= j2;
                i++;
            } else {
                long[] jArr3 = this.f2359kw;
                jArr3[i2] = j;
    ...
    public static abstract class ThreefishCipher {
        ...
        /* renamed from: kw */
        protected final long[] f2361kw;

        /* renamed from: t */
        protected final long[] f2362t;
    ...
    private static final class Threefish256Cipher extends ThreefishCipher {
        ...
        void encryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f2361kw;
            long[] jArr4 = this.f2362t;
