...
public class DRBG {
    ...
    public static SecureRandom createBaseRandom(boolean z) {
        ...
        if (System.getProperty("org.spongycastle.drbg.entropysource") != null) {
            ...
            if (z) {
                generateNonceIVPersonalizationString2 = generateDefaultPersonalizationString(entropySource.getEntropy());
            } else {
                generateNonceIVPersonalizationString2 = generateNonceIVPersonalizationString(entropySource.getEntropy());
            }
            return new SP800SecureRandomBuilder(createEntropySource).setPersonalizationString(generateNonceIVPersonalizationString2).buildHash(new SHA512Digest(), Arrays.concatenate(entropySource.getEntropy(), entropySource.getEntropy()), z);
        }
        HybridSecureRandom hybridSecureRandom = new HybridSecureRandom();
        if (z) {
            generateNonceIVPersonalizationString = generateDefaultPersonalizationString(hybridSecureRandom.generateSeed(16));
        } else {
            generateNonceIVPersonalizationString = generateNonceIVPersonalizationString(hybridSecureRandom.generateSeed(16));
        }
        return new SP800SecureRandomBuilder(hybridSecureRandom, true).setPersonalizationString(generateNonceIVPersonalizationString).buildHash(new SHA512Digest(), hybridSecureRandom.generateSeed(32), z);
    }
    ...
    public static class HybridSecureRandom extends SecureRandom {
        ...
        HybridSecureRandom() {
            ...
            SecureRandom access$300 = DRBG.access$300();
            this.baseRandom = access$300;
            ...
            }).setPersonalizationString(Strings.toByteArray("Bouncy Castle Hybrid Entropy Source")).buildHMAC(new HMac(new SHA512Digest()), access$300.generateSeed(32), false);
        }
