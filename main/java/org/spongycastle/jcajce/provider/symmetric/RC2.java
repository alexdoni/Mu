...
public final class RC2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        protected byte[] engineGetEncoded() {
            return Arrays.clone(this.f2574iv);
        }
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (i = this.parameterVersion) != -1) {
                if (i < 256) {
                    return new RC2ParameterSpec(ekb[this.parameterVersion], this.f2574iv);
                }
                return new RC2ParameterSpec(this.parameterVersion, this.f2574iv);
            }
            if (cls == IvParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new IvParameterSpec(this.f2574iv);
            }
        ...
        protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f2574iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
                return;
            }
            if (algorithmParameterSpec instanceof RC2ParameterSpec) {
                ...
                this.f2574iv = rC2ParameterSpec.getIV();
                return;
            }
        ...
        protected void engineInit(byte[] bArr) throws IOException {
            this.f2574iv = Arrays.clone(bArr);
        }
        ...
        protected void engineInit(byte[] bArr, String str) throws IOException {
            if (isASN1FormatString(str)) {
                ...
                this.f2574iv = rC2CBCParameter.getIV();
                return;
            }
            if (str.equals("RAW")) {
                engineInit(bArr);
