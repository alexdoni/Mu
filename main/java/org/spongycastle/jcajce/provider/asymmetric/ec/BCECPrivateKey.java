...
public class BCECPrivateKey implements ECPrivateKey, org.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    /* renamed from: d */
    private transient BigInteger f2556d;
    ...
    public BCECPrivateKey(String str, ECPrivateKeySpec eCPrivateKeySpec, ProviderConfiguration providerConfiguration) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f2556d = eCPrivateKeySpec.getD();
    ...
    public BCECPrivateKey(String str, java.security.spec.ECPrivateKeySpec eCPrivateKeySpec, ProviderConfiguration providerConfiguration) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f2556d = eCPrivateKeySpec.getS();
    ...
    public BCECPrivateKey(String str, BCECPrivateKey bCECPrivateKey) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f2556d = bCECPrivateKey.f2556d;
    ...
    public BCECPrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECPublicKey bCECPublicKey, ECParameterSpec eCParameterSpec, ProviderConfiguration providerConfiguration) {
        ...
        this.algorithm = str;
        this.f2556d = eCPrivateKeyParameters.getD();
        this.configuration = providerConfiguration;
    ...
    public String toString() {
        return ECUtil.privateKeyToString("EC", this.f2556d, engineGetSpec());
    }

    private org.spongycastle.math.ec.ECPoint calculateQ(org.spongycastle.jce.spec.ECParameterSpec eCParameterSpec) {
        return eCParameterSpec.getG().multiply(this.f2556d).normalize();
    }
