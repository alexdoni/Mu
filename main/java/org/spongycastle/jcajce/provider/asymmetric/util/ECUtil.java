...
public class ECUtil {
    ...
    public static String privateKeyToString(String str, BigInteger bigInteger, ECParameterSpec eCParameterSpec) {
        ...
        stringBuffer.append(" Private Key [").append(generateKeyFingerprint(calculateQ, eCParameterSpec)).append("]").append(lineSeparator);
        stringBuffer.append("            X: ").append(calculateQ.getAffineXCoord().toBigInteger().toString(16)).append(lineSeparator);
        stringBuffer.append("            Y: ").append(calculateQ.getAffineYCoord().toBigInteger().toString(16)).append(lineSeparator);
