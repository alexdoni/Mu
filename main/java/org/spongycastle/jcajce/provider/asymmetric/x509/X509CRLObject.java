...
class X509CRLObject extends X509CRL {
    ...
    /* renamed from: c */
    private CertificateList f2566c;
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f2566c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f2566c.getTBSCertList().getExtensions();
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f2566c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (!this.f2566c.getSignatureAlgorithm().equals(this.f2566c.getTBSCertList().getSignature())) {
    ...
    public int getVersion() {
        return this.f2566c.getVersionNumber();
    }

    @Override // java.security.cert.X509CRL
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f2566c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f2566c.getIssuer().getEncoded());
    ...
    public Date getThisUpdate() {
        return this.f2566c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public Date getNextUpdate() {
        if (this.f2566c.getNextUpdate() != null) {
            return this.f2566c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f2566c.getRevokedCertificateEnumeration();
    ...
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f2566c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public byte[] getSignature() {
        return this.f2566c.getSignature().getOctets();
    }
    ...
    public String getSigAlgOID() {
        return this.f2566c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f2566c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f2566c.getIssuer();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            return this.f2566c.equals(x509CRLObject.f2566c);
        }
