...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Set getExtensionOIDs(boolean z) {
        Extensions extensions = this.f2565c.getExtensions();
        if (extensions == null) {
            return null;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            return this.f2565c.equals(((X509CRLEntryObject) obj).f2565c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f2565c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public BigInteger getSerialNumber() {
        return this.f2565c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public Date getRevocationDate() {
        return this.f2565c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f2565c.getExtensions() != null;
    }
