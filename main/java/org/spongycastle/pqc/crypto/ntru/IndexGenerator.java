...
public class IndexGenerator {
    ...
    public IndexGenerator(byte[] bArr, NTRUEncryptionParameters nTRUEncryptionParameters) {
        this.seed = bArr;
        this.f2794N = nTRUEncryptionParameters.f2803N;
        this.f2795c = nTRUEncryptionParameters.f2804c;
    ...
    public int nextIndex() {
        ...
        do {
            ...
            leadingAsInt = trailing.getLeadingAsInt(this.f2795c);
            i = this.f2795c;
            i2 = this.f2794N;
