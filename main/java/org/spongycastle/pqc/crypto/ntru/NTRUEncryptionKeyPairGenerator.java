...
public class NTRUEncryptionKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        int i = this.params.f2796N;
        int i2 = this.params.f2802q;
        int i3 = this.params.f2799df;
        int i4 = this.params.df1;
        int i5 = this.params.df2;
        int i6 = this.params.df3;
        int i7 = this.params.f2800dg;
        ...
        while (true) {
            if (z) {
                ...
                generateRandomTernary = this.params.polyType == 0 ? Util.generateRandomTernary(i, i3, i3 - 1, z2, this.params.getRandom()) : ProductFormPolynomial.generateRandom(i, i4, i5, i6, i6 - 1, this.params.getRandom());
                integerPolynomial = generateRandomTernary.toIntegerPolynomial();
