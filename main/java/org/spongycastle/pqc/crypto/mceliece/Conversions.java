        ...
        for (int i4 = 0; i4 < i; i4++) {
            ...
            if (binomial.compareTo(bigInteger) <= 0) {
                ...
                if (i3 == i2) {
                    ...
                    binomial = binomial.multiply(BigInteger.valueOf(i2 + 1)).divide(BigInteger.valueOf(i3 - i2));
                }
            }
        }
        return gF2Vector;
        ...
        for (int i10 = 0; i10 < i; i10++) {
            ...
            if (((byte) (bArr2[i10 >>> 3] & (1 << (i10 & 7)))) != 0) {
                ...
                if (i9 == i2) {
                    ...
                    binomial = binomial.multiply(new BigInteger(Integer.toString(i2 + 1))).divide(new BigInteger(Integer.toString(i9 - i2)));
                }
            }
        }
        int i11 = i3 + 1;
