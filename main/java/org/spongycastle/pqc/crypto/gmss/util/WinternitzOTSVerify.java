...
public class WinternitzOTSVerify {
    ...
    public int getSignatureLength() {
        ...
        return digestSize * (i2 + (((log + r3) - 1) / this.f2750w));
    }
        ...
        if (8 % i6 == 0) {
            ...
            while (i11 < digestSize2) {
                while (i2 < i9) {
                    ...
                    bArr5[i11] = (byte) (bArr5[i11] >>> this.f2750w);
                    i13++;
                    i2++;
                    digestSize2 = i15;
                    bArr3 = bArr2;
            ...
            if (i6 < 8) {
                ...
                byte[] bArr9 = bArr8;
                int i35 = digestSize % this.f2750w;
                long j2 = 0;
