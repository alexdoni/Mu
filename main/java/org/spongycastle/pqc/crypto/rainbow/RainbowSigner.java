...
public class RainbowSigner implements MessageSigner {
    ...
    /* renamed from: cf */
    private ComputeInField f2845cf = new ComputeInField();
    RainbowKeyParameters key;
    private SecureRandom random;
    int signableDocumentLength;

    /* renamed from: x */
    private short[] f2846x;
    ...
    private short[] initSign(Layer[] layerArr, short[] sArr) {
        ...
        short[] multiplyMatrix = this.f2845cf.multiplyMatrix(((RainbowPrivateKeyParameters) this.key).getInvA1(), this.f2845cf.addVect(((RainbowPrivateKeyParameters) this.key).getB1(), sArr));
        for (int i = 0; i < layerArr[0].getVi(); i++) {
            this.f2846x[i] = (short) this.random.nextInt();
            short[] sArr3 = this.f2846x;
    ...
    public byte[] generateSignature(byte[] bArr) {
        ...
        this.f2846x = new short[((RainbowPrivateKeyParameters) this.key).getInvA2().length];
        ...
        do {
            try {
                ...
                for (int i3 = 0; i3 < length; i3++) {
                    ...
                    short[] solveEquation = this.f2845cf.solveEquation(layers[i3].plugInVinegars(this.f2846x), sArr);
                    if (solveEquation == null) {
                        throw new Exception("LES is not solveable!");
                        break;
                    }
                    for (int i5 = 0; i5 < solveEquation.length; i5++) {
                        this.f2846x[layers[i3].getVi() + i5] = solveEquation[i5];
                    }
                }
                short[] multiplyMatrix = this.f2845cf.multiplyMatrix(((RainbowPrivateKeyParameters) this.key).getInvA2(), this.f2845cf.addVect(((RainbowPrivateKeyParameters) this.key).getB2(), this.f2846x));
