...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i) {
        ...
        this.length = i;
        this.f2864v = new int[(i + 31) >> 5];
    }

    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f2864v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f2864v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f2864v = IntUtils.clone(gF2Vector.f2864v);
    }
    ...
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f2864v, (this.length + 7) >> 3);
    }
    ...
    public boolean isZero() {
        for (int length = this.f2864v.length - 1; length >= 0; length--) {
            if (this.f2864v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public Vector add(Vector vector) {
        ...
        int[] clone = IntUtils.clone(gF2Vector.f2864v);
        for (int length = clone.length - 1; length >= 0; length--) {
            clone[length] = clone[length] ^ this.f2864v[length];
        }
    ...
    public GF2Vector extractVector(int[] iArr) {
        ...
        for (int i = 0; i < length; i++) {
            int[] iArr2 = this.f2864v;
            int i2 = iArr[i];
            if ((iArr2[i2 >> 5] & (1 << (i2 & 31))) != 0) {
                int[] iArr3 = gF2Vector.f2864v;
                int i3 = i >> 5;
    ...
    public GF2Vector extractLeftVector(int i) {
        ...
        int i2 = i >> 5;
        int i3 = i & 31;
        System.arraycopy(this.f2864v, 0, gF2Vector.f2864v, 0, i2);
        if (i3 != 0) {
            gF2Vector.f2864v[i2] = ((1 << i3) - 1) & this.f2864v[i2];
        }
        return gF2Vector;
    }
    ...
    public GF2Vector extractRightVector(int i) {
        ...
        if (i4 != 0) {
            ...
            System.arraycopy(this.f2864v, i3, gF2Vector.f2864v, 0, i5);
        }
        return gF2Vector;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f2864v, gF2Vector.f2864v);
    }

    @Override // org.spongycastle.pqc.math.linearalgebra.Vector
    public int hashCode() {
        return (this.length * 31) + this.f2864v.hashCode();
    }
