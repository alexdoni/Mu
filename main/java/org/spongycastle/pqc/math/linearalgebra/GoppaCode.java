...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f2867h;

        /* renamed from: p */
        private Permutation f2868p;

        /* renamed from: s */
        private GF2Matrix f2869s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f2869s = gF2Matrix;
            this.f2867h = gF2Matrix2;
            this.f2868p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f2870g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f2870g = gF2Matrix;
            this.setJ = iArr;
        }
