...
public class PolynomialRingGF2m {
    ...
    /* renamed from: p */
    private PolynomialGF2mSmallM f2872p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f2872p = polynomialGF2mSmallM;
    ...
    private void computeSquaringMatrix() {
        int i;
        int degree = this.f2872p.getDegree();
        ...
        while (i < degree) {
            ...
            iArr2[i4] = 1;
            this.sqMatrix[i] = new PolynomialGF2mSmallM(this.field, iArr2).mod(this.f2872p);
            i++;
        }
    }
