...
public class JCEECPublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f2582q = jCEECPublicKey.f2582q;
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f2582q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }

    public JCEECPublicKey(String str, org.spongycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = str;
        this.f2582q = eCPublicKeySpec.getQ();
        ...
        if (this.f2582q.getCurve() == null) {
            this.f2582q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f2582q.getAffineXCoord().toBigInteger(), this.f2582q.getAffineYCoord().toBigInteger(), false);
        }
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f2582q = eCPublicKeyParameters.getQ();
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f2582q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (subjectPublicKeyInfo.getAlgorithmId().getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f2582q = curve2.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2), false);
        ...
        this.f2582q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f2582q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f2582q.getAffineYCoord().toBigInteger();
    ...
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f2582q.getAffineXCoord().toBigInteger(), this.f2582q.getAffineYCoord().toBigInteger());
    }

    @Override // org.spongycastle.jce.interfaces.ECPublicKey
    public ECPoint getQ() {
        if (this.ecSpec == null) {
            return this.f2582q.getDetachedPoint();
        }
        return this.f2582q;
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("            X: ").append(this.f2582q.getAffineXCoord().toBigInteger().toString(16)).append(lineSeparator);
        stringBuffer.append("            Y: ").append(this.f2582q.getAffineYCoord().toBigInteger().toString(16)).append(lineSeparator);
