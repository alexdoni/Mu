...
public class PKIXNameConstraintValidator {
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return Collections.singleton(ipWithSubnetMask(m1539or(minMaxIPs[0], minMaxIPs[2]), m1539or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m1539or(byte[] bArr, byte[] bArr2) {
    ...
    private String stringifyIP(byte[] bArr) {
        ...
        String str2 = str.substring(0, str.length() - 1) + RemoteSettings.FORWARD_SLASH_STRING;
