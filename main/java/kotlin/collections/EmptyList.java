...
public final class EmptyList implements List, Serializable, RandomAccess, KMappedMarker {
    ...
    public Void get(int index) {
        throw new IndexOutOfBoundsException("Empty list doesn't contain element at index " + index + JwtParser.SEPARATOR_CHAR);
    }
