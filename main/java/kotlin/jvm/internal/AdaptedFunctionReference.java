...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public int hashCode() {
        ...
        Class cls = this.owner;
        return ((((((((((hashCode + (cls != null ? cls.hashCode() : 0)) * 31) + this.name.hashCode()) * 31) + this.signature.hashCode()) * 31) + (this.isTopLevel ? UpdateHelper.UPDATE_REQUEST_CODE : 1237)) * 31) + this.arity) * 31) + this.flags;
    }
