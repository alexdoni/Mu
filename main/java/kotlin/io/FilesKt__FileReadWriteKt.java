    ...
    public static final byte[] readBytes(File file) {
        ...
        try {
            ...
            if (i2 > 0) {
                ...
                if (read2 != -1) {
                    ExposingBufferByteArrayOutputStream exposingBufferByteArrayOutputStream = new ExposingBufferByteArrayOutputStream(PttError.VOICE_UPLOAD_FILE_ACCESSERROR);
