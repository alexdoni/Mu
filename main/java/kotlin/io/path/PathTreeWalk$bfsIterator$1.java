...
@DebugMetadata(m1414c = "kotlin.io.path.PathTreeWalk$bfsIterator$1", m1415f = "PathTreeWalk.kt", m1416i = {0, 0, 0, 0, 0, 0, 1, 1, 1}, m1417l = {CipherSuite.TLS_RSA_PSK_WITH_NULL_SHA256, 190}, m1418m = "invokeSuspend", m1419n = {"$this$iterator", "queue", "entriesReader", "pathNode", "this_$iv", "path$iv", "$this$iterator", "queue", "entriesReader"}, m1420s = {"L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$0", "L$1", "L$2"})
