...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes.dex */
    public static final class C0418Op {
        int mCmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0418Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0418Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0418Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C0418Op(C0418Op c0418Op) {
            this.mCmd = c0418Op.mCmd;
            this.mFragment = c0418Op.mFragment;
            this.mFromExpandedOp = c0418Op.mFromExpandedOp;
            this.mEnterAnim = c0418Op.mEnterAnim;
            this.mExitAnim = c0418Op.mExitAnim;
            this.mPopEnterAnim = c0418Op.mPopEnterAnim;
            this.mPopExitAnim = c0418Op.mPopExitAnim;
            this.mOldMaxState = c0418Op.mOldMaxState;
            this.mCurrentMaxState = c0418Op.mCurrentMaxState;
        }
    }
    ...
    public FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C0418Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C0418Op(it.next()));
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void addOp(C0418Op c0418Op) {
        this.mOps.add(c0418Op);
        c0418Op.mEnterAnim = this.mEnterAnim;
        c0418Op.mExitAnim = this.mExitAnim;
        c0418Op.mPopEnterAnim = this.mPopEnterAnim;
        c0418Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0418Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0418Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0418Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0418Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0418Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0418Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0418Op(10, fragment, state));
        return this;
    }
