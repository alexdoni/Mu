...
public abstract class SpecialEffectsController {
    ...
    public static SpecialEffectsController getOrCreateController(ViewGroup viewGroup, SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        Object tag = viewGroup.getTag(C0371R.id.special_effects_controller_view_tag);
        if (tag instanceof SpecialEffectsController) {
            return (SpecialEffectsController) tag;
        }
        SpecialEffectsController createController = specialEffectsControllerFactory.createController(viewGroup);
        viewGroup.setTag(C0371R.id.special_effects_controller_view_tag, createController);
    ...
    public static class Operation {
        ...
        public enum State {
            ...
            public void applyState(View view) {
                int i = C04293.f113xe493b431[ordinal()];
                if (i == 1) {
        ...
        final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int i = C04293.f112xb9e640f0[lifecycleImpact.ordinal()];
            if (i == 1) {
    ...
    public static /* synthetic */ class C04293 {
        ...
        static {
            ...
            try {
                f112xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f112xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f113xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f113xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f113xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
