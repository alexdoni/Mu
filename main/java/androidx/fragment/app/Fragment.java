...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void performConfigurationChanged(Configuration configuration) {
        ...
        this.mChildFragmentManager.m1586lambda$new$0$androidxfragmentappFragmentManager(configuration);
    }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m1585lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m1585lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m1585lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m1585lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
