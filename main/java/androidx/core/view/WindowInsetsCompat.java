...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f2909top;
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m10of(i, i2, i3, i4)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m11of(rect)).build();
    }

    @Deprecated
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f2909top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f2909top, insets.right, insets.bottom);
    }
    ...
    public static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 1) {
                if (z) {
                    return Insets.m10of(0, Math.max(getRootStableInsets().f2909top, getSystemWindowInsets().f2909top), 0, 0);
                }
                return Insets.m10of(0, getSystemWindowInsets().f2909top, 0, 0);
            }
            if (i == 2) {
                if (z) {
                    Insets rootStableInsets = getRootStableInsets();
                    Insets stableInsets2 = getStableInsets();
                    return Insets.m10of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m10of(systemWindowInsets.left, 0, systemWindowInsets.right, i2);
            }
            if (i == 8) {
                ...
                if (systemWindowInsets2.bottom > rootStableInsets2.bottom) {
                    return Insets.m10of(0, 0, 0, systemWindowInsets2.bottom);
                }
                ...
                if (insets != null && !insets.equals(Insets.NONE) && this.mRootViewVisibleInsets.bottom > rootStableInsets2.bottom) {
                    return Insets.m10of(0, 0, 0, this.mRootViewVisibleInsets.bottom);
                }
                return Insets.NONE;
            }
            if (i == 16) {
            ...
            if (i == 128) {
                ...
                if (displayCutout != null) {
                    return Insets.m10of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom());
                }
                return Insets.NONE;
            }
            return Insets.NONE;
    ...
    public static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f2909top - i2);
        int max3 = Math.max(0, insets.right - i3);
        int max4 = Math.max(0, insets.bottom - i4);
        return (max == i && max2 == i2 && max3 == i3 && max4 == i4) ? insets : Insets.m10of(max, max2, max3, max4);
    }
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f2909top, insets.right, insets.bottom);
            }
        }
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m11of(rect)).setSystemWindowInsets(Insets.m11of(rect2)).build();
