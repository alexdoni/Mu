...
public class AccessibilityNodeInfoCompat {
            ...
            if (cls != null) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + (cls2 == null ? JsonSerializer.Null : cls2.getName()), e);
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            getExtras().putInt(SPANS_ACTION_ID_KEY, C0213R.id.accessibility_action_clickable_span);
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        view.setTag(C0213R.id.tag_accessibility_clickable_spans, sparseArray);
        return sparseArray;
    }

    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C0213R.id.tag_accessibility_clickable_spans);
    }
