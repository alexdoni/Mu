...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m34x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m35y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m36z(float f) {
        View view = this.mView.get();
        if (view != null) {
            Api21Impl.m37z(view.animate(), f);
        }
        return this;
    }
    ...
    static class Api21Impl {
        ...
        /* renamed from: z */
        static ViewPropertyAnimator m37z(ViewPropertyAnimator viewPropertyAnimator, float f) {
