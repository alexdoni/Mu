...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ...
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0053R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0053R.id.action_context_bar);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0053R.styleable.ActionBar, C0053R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0053R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0053R.styleable.ActionBar_elevation, 0);
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        sb.append(view != 0 ? view.getClass().getSimpleName() : JsonSerializer.Null);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0053R.attr.actionBarWidgetTheme, typedValue, true);
