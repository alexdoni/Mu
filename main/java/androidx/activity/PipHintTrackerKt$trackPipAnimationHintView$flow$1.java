...
@Metadata(m1394d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m1395d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Landroid/graphics/Rect;"}, m1396k = 3, m1397mv = {1, 6, 0}, m1399xi = 48)
@DebugMetadata(m1414c = "androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1", m1415f = "PipHintTracker.kt", m1416i = {}, m1417l = {87}, m1418m = "invokeSuspend", m1419n = {}, m1420s = {})
...
final class PipHintTrackerKt$trackPipAnimationHintView$flow$1 extends SuspendLambda implements Function2<ProducerScope<? super Rect>, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            final View.OnLayoutChangeListener onLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$$ExternalSyntheticLambda0
                ...
                public final void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                    PipHintTrackerKt$trackPipAnimationHintView$flow$1.m1560invokeSuspend$lambda0(ProducerScope.this, view, i2, i3, i4, i5, i6, i7, i8, i9);
                }
            };
            ...
            final ViewTreeObserver.OnScrollChangedListener onScrollChangedListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$$ExternalSyntheticLambda1
                ...
                public final void onScrollChanged() {
                    PipHintTrackerKt$trackPipAnimationHintView$flow$1.m1561invokeSuspend$lambda1(ProducerScope.this, view);
                }
            };
            ...
            final ?? r3 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                ...
                public void onViewAttachedToWindow(View v) {
                    ...
                    producerScope2.mo3385trySendJP2dKIU(trackPipAnimationHintView$positionInWindow2);
            ...
            if (Api19Impl.INSTANCE.isAttachedToWindow(this.$view)) {
                ...
                producerScope.mo3385trySendJP2dKIU(trackPipAnimationHintView$positionInWindow);
    ...
    public static final void m1560invokeSuspend$lambda0(ProducerScope producerScope, View v, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        Rect trackPipAnimationHintView$positionInWindow;
    ...
    public static final void m1561invokeSuspend$lambda1(ProducerScope producerScope, View view) {
        Rect trackPipAnimationHintView$positionInWindow;
