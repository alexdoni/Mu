...
public class CLToken extends CLElement {
    ...
    public CLToken(char[] cArr) {
        ...
        this.tokenFalse = JsonSerializer.False.toCharArray();
        this.tokenNull = JsonSerializer.Null.toCharArray();
    }
    ...
    public boolean validate(char c, long j) {
        int i = C01741.$SwitchMap$androidx$constraintlayout$core$parser$CLToken$Type[this.type.ordinal()];
        if (i == 1) {
