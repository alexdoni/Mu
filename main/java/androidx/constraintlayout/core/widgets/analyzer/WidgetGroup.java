...
public class WidgetGroup {
    ...
    public class MeasureResult {
        ...
        public MeasureResult(ConstraintWidget constraintWidget, LinearSystem linearSystem, int i) {
            ...
            this.f2905top = linearSystem.getObjectVariableValue(constraintWidget.mTop);
        ...
        public void apply() {
            ...
            if (constraintWidget != null) {
                constraintWidget.setFinalFrame(this.left, this.f2905top, this.right, this.bottom, this.baseline, this.orientation);
            }
        }
    }
}
