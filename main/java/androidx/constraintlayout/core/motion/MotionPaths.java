...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.f21x = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f22y = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 0;
        this.f21x = (int) (((motionPaths.f21x + (f14 * f10)) + (f16 * f11)) - f12);
        this.f22y = (int) (((motionPaths.f22y + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.f21x = (int) ((f6 + f12) - f13);
        float f14 = f * f11;
        float f15 = (f5 * f3) / 2.0f;
        this.f22y = (int) ((f8 + f14) - f15);
        ...
        this.mMode = 1;
        float f17 = (int) ((motionPaths.f21x + f12) - f13);
        this.f21x = f17;
        float f18 = (int) ((motionPaths.f22y + f14) - f15);
        this.f21x = f17 + ((-f11) * f16);
        this.f22y = f18 + (f10 * f16);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean diff = diff(this.f21x, motionPaths.f21x);
        boolean diff2 = diff(this.f22y, motionPaths.f22y);
