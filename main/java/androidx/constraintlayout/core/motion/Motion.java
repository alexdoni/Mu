...
public class Motion implements TypedValues {
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.f2901top = this.mStartMotionPath.f22y;
        floatRect.right = floatRect.left + this.mStartMotionPath.width;
        floatRect.bottom = floatRect.f2901top + this.mStartMotionPath.height;
        FloatRect floatRect2 = new FloatRect();
        floatRect2.left = this.mEndMotionPath.f21x;
        floatRect2.f2901top = this.mEndMotionPath.f22y;
        floatRect2.right = floatRect2.left + this.mEndMotionPath.width;
        floatRect2.bottom = floatRect2.f2901top + this.mEndMotionPath.height;
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i18 = 0; i18 < size; i18++) {
                ...
                dArr6[i18][0] = motionPathsArr[i18].f21x;
                dArr6[i18][1] = motionPathsArr[i18].f22y;
            }
    ...
    public void setStartState(ViewState viewState, MotionWidget motionWidget, int i, int i2, int i3) {
        ...
        if (i == 1) {
            ...
            rect.left = ((viewState.f2903top + viewState.bottom) - viewState.width()) / 2;
            rect.f2902top = i2 - ((i4 + viewState.height()) / 2);
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f2902top + viewState.height();
        } else if (i == 2) {
            int i5 = viewState.left + viewState.right;
            rect.left = i3 - (((viewState.f2903top + viewState.bottom) + viewState.width()) / 2);
            rect.f2902top = (i5 - viewState.height()) / 2;
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f2902top + viewState.height();
        }
        this.mStartMotionPath.setBounds(rect.left, rect.f2902top, rect.width(), rect.height());
    ...
    void rotate(Rect rect, Rect rect2, int i, int i2, int i3) {
        if (i == 1) {
            ...
            rect2.left = ((rect.f2902top + rect.bottom) - rect.width()) / 2;
            rect2.f2902top = i3 - ((i4 + rect.height()) / 2);
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f2902top + rect.height();
            return;
        }
        if (i == 2) {
            int i5 = rect.left + rect.right;
            rect2.left = i2 - (((rect.f2902top + rect.bottom) + rect.width()) / 2);
            rect2.f2902top = (i5 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f2902top + rect.height();
            return;
        }
        if (i != 3) {
            ...
            rect2.left = i2 - (((rect.bottom + rect.f2902top) + rect.width()) / 2);
            rect2.f2902top = (i6 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f2902top + rect.height();
            return;
        }
        int i7 = rect.left + rect.right;
        int i8 = rect.f2902top;
        int i9 = rect.bottom;
        rect2.left = ((rect.height() / 2) + rect.f2902top) - (i7 / 2);
        rect2.f2902top = i3 - ((i7 + rect.height()) / 2);
        rect2.right = rect2.left + rect.width();
        rect2.bottom = rect2.f2902top + rect.height();
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f6 = this.mStartMotionPath.f21x + ((this.mEndMotionPath.f21x - this.mStartMotionPath.f21x) * f5) + 0.5f;
            float f7 = this.mStartMotionPath.f22y + ((this.mEndMotionPath.f22y - this.mStartMotionPath.f22y) * f5) + 0.5f;
