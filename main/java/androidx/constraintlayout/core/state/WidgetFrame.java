...
public class WidgetFrame {
    ...
    public int height() {
        return Math.max(0, this.bottom - this.f2904top);
    }
    ...
    public WidgetFrame(WidgetFrame widgetFrame) {
        ...
        this.f2904top = widgetFrame.f2904top;
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i15 = widgetFrame2.f2904top;
        int i16 = widgetFrame3.left;
        int i17 = widgetFrame3.f2904top;
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                i5 = (int) (findPreviousPosition.f38x * i);
                i10 = i16;
                i9 = i2;
                i6 = (int) (findPreviousPosition.f39y * i9);
            ...
            if (findNextPosition != null) {
                int i22 = (int) (findNextPosition.f38x * i);
                int i23 = (int) (findNextPosition.f39y * i9);
    ...
    public float centerY() {
        return this.f2904top + ((this.bottom - r0) / 2.0f);
    }
    ...
    public WidgetFrame update() {
        ...
        if (constraintWidget != null) {
            ...
            this.f2904top = this.widget.getTop();
    ...
    public boolean setValue(String str, CLElement cLElement) throws CLParsingException {
        ...
        switch (c) {
            ...
            case '\f':
                ...
                return true;
            case '\r':
                this.f2904top = cLElement.getInt();
                return true;
            case 14:
    ...
    public StringBuilder serialize(StringBuilder sb, boolean z) {
        ...
        add(sb, ViewHierarchyConstants.DIMENSION_TOP_KEY, this.f2904top);
