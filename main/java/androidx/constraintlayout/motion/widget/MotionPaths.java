...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    static String[] names = {RequestParameters.POSITION, "x", "y", ViewHierarchyConstants.DIMENSION_WIDTH_KEY, ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, "pathRotate"};
    ...
    void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        this.f57x = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f58y = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 0;
        this.f57x = (int) (((startTimePoint.f57x + (f14 * f10)) + (f16 * f11)) - f12);
        this.f58y = (int) (((startTimePoint.f58y + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        this.f57x = (int) ((f6 + f12) - f13);
        float f14 = f * f11;
        float f15 = (f5 * f3) / 2.0f;
        this.f58y = (int) ((f8 + f14) - f15);
        this.width = (int) (f7 + r7);
        this.height = (int) (f9 + r8);
        float f16 = Float.isNaN(c.mPercentY) ? 0.0f : c.mPercentY;
        this.mMode = 1;
        float f17 = (int) ((startTimePoint.f57x + f12) - f13);
        this.f57x = f17;
        float f18 = (int) ((startTimePoint.f58y + f14) - f15);
        this.f57x = f17 + ((-f11) * f16);
        this.f58y = f18 + (f10 * f16);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(c.mTransitionEasing);
        this.mPathMotionArc = c.mPathMotionArc;
    }
    ...
    public void different(MotionPaths points, boolean[] mask, String[] custom, boolean arcMode) {
        boolean diff = diff(this.f57x, points.f57x);
        boolean diff2 = diff(this.f58y, points.f58y);
