...
public class MotionController {
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < size; i17++) {
                ...
                dArr6[i17][0] = motionPathsArr[i17].f57x;
                dArr6[i17][1] = motionPathsArr[i17].f58y;
            }
    ...
    public void setStartState(ViewState rect, View v, int rotation, int preWidth, int preHeight) {
        ...
        if (rotation == 1) {
            ...
            rect2.left = ((rect.f2906top + rect.bottom) - rect.width()) / 2;
            rect2.top = preWidth - ((i + rect.height()) / 2);
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.top + rect.height();
        } else if (rotation == 2) {
            int i2 = rect.left + rect.right;
            rect2.left = preHeight - (((rect.f2906top + rect.bottom) + rect.width()) / 2);
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i = 1;
            float f5 = this.mStartMotionPath.f57x + ((this.mEndMotionPath.f57x - this.mStartMotionPath.f57x) * f4);
            float f6 = f5 + 0.5f;
            int i4 = (int) f6;
            float f7 = this.mStartMotionPath.f58y + ((this.mEndMotionPath.f58y - this.mStartMotionPath.f58y) * f4) + 0.5f;
            int i5 = (int) f7;
