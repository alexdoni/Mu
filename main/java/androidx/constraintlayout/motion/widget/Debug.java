...
public class Debug {
    public static void logStack(String tag, String msg, int n) {
        ...
        for (int i = 1; i <= min; i++) {
            ...
            str = str + " ";
            Log.v(tag, msg + str + (".(" + stackTrace[i].getFileName() + CertificateUtil.DELIMITER + stackTrace[i].getLineNumber() + ") " + stackTrace[i].getMethodName()) + str);
        }
    }
    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(Constants.SDK_LOGIN_TYPE_LOGOUT)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
    ...
    public static String getState(MotionLayout layout, int stateId, int len) {
        ...
        return resourceEntryName.replaceAll(CharBuffer.allocate((resourceEntryName.length() - len) / length).toString().replace((char) 0, JwtParser.SEPARATOR_CHAR) + "_", "_");
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (int i2 = 0; i2 < fields.length; i2++) {
                ...
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(Constants.SDK_LOGIN_TYPE_LOGOUT)) {
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams param, String str) {
        ...
        for (Field field : param.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(Constants.SDK_LOGIN_TYPE_LOGOUT)) {
