...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m1394d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m1395d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it"}, m1396k = 3, m1397mv = {1, 5, 1}, m1399xi = 48)
    @DebugMetadata(m1414c = "androidx.datastore.migrations.SharedPreferencesMigration$1", m1415f = "SharedPreferencesMigration.kt", m1416i = {}, m1417l = {}, m1418m = "invokeSuspend", m1419n = {}, m1420s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$1 */
    /* loaded from: classes.dex */
    static final class C02861 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02861(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02861) obj, continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02861) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C02861 c02861, Function3 function3, Context context, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) set, (i & 4) != 0 ? new C02861(null) : c02861, function3, context, str);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m1394d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m1395d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it"}, m1396k = 3, m1397mv = {1, 5, 1}, m1399xi = 48)
    @DebugMetadata(m1414c = "androidx.datastore.migrations.SharedPreferencesMigration$2", m1415f = "SharedPreferencesMigration.kt", m1416i = {}, m1417l = {}, m1418m = "invokeSuspend", m1419n = {}, m1420s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$2 */
    /* loaded from: classes.dex */
    public static final class C02872 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C02872(Continuation<? super C02872> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02872(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02872) obj, continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02872) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C02872 c02872, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) ((i & 2) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set), (i & 4) != 0 ? new C02872(null) : c02872, function3);
    }
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m1394d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m1395d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it"}, m1396k = 3, m1397mv = {1, 5, 1}, m1399xi = 48)
    @DebugMetadata(m1414c = "androidx.datastore.migrations.SharedPreferencesMigration$3", m1415f = "SharedPreferencesMigration.kt", m1416i = {}, m1417l = {}, m1418m = "invokeSuspend", m1419n = {}, m1420s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$3 */
    /* loaded from: classes.dex */
    public static final class C02883 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02883) obj, continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02883) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, C02883 c02883, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, (i & 4) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set, (i & 8) != 0 ? new C02883(null) : c02883, function3);
    }
    ...
    */
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m1394d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m1395d2 = {"Landroidx/datastore/migrations/SharedPreferencesMigration$Api24Impl;", "", "()V", "deleteSharedPreferences", "", "context", "Landroid/content/Context;", "name", "", "datastore_release"}, m1396k = 1, m1397mv = {1, 5, 1}, m1399xi = 48)
    /* loaded from: classes.dex */
