...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        /* synthetic */ FieldType(String str, int i, JavaType javaType, int i2, C03561 c03561) {
    ...
    public enum Utf8Validation {
        ...
        /* synthetic */ Utf8Validation(C03561 c03561) {
            this();
        }
    }
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (C03561.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
