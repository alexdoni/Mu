...
public class AnimatorInflaterCompat {
    ...
    private static void parseAnimatorFromTypeArray(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        long namedInt = TypedArrayUtils.getNamedInt(typedArray, xmlPullParser, TypedValues.TransitionType.S_DURATION, 1, CallCode.HTTP_MULT_CHOICE);
    ...
    */
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            Object obj = JsonSerializer.Null;
            sb.append(fraction < 0.0f ? JsonSerializer.Null : Float.valueOf(keyframe.getFraction()));
            sb.append(", , value : ");
