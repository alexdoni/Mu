...
@Metadata(m1394d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m1395d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/channels/ProducerScope;"}, m1396k = 3, m1397mv = {1, 6, 0}, m1399xi = 48)
@DebugMetadata(m1414c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1", m1415f = "FlowExt.kt", m1416i = {0}, m1417l = {91}, m1418m = "invokeSuspend", m1419n = {"$this$callbackFlow"}, m1420s = {"L$0"})
...
final class FlowExtKt$flowWithLifecycle$1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: FlowExt.kt */
    @Metadata(m1394d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m1395d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m1396k = 3, m1397mv = {1, 6, 0}, m1399xi = 48)
    @DebugMetadata(m1414c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1", m1415f = "FlowExt.kt", m1416i = {}, m1417l = {92}, m1418m = "invokeSuspend", m1419n = {}, m1420s = {})
    ...
    public static final class C04391 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04391(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C04391> continuation) {
            super(2, continuation);
            this.$this_flowWithLifecycle = flow;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04391(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C04391(this.$this_flowWithLifecycle, producerScope2, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
